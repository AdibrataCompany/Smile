			...
			<center>
				...
				<table width="100%">
					<tr>
						...
						<td width="30%"><s:textfield name="destination" /></td>
					...
					<tr>
						...
						<td valign="top">IDR <s:textfield name="disbAmount" /></td>
					</tr>
				</table>
				<br>
				<table>
					...
					<tr>
						...
						<td width="30%"><input name="amount" type="text"></td>
					</tr>
					<tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td><button type="submit"
														class="btn btn-sm btn-primary" onclick="savedel()">Hapus</button></td>
												<th align="center">TRANSACTION DETAIL</th>
												<td align="right"><button type="submit"
														class="btn btn-sm btn-primary" onclick="saveadd()">Tambah</button>
											</tr>
