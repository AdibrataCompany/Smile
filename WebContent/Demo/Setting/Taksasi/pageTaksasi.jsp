				...
				<tr>
					...
					<td>
						<select>
							...
							<option value="assetMasterCode">Asset Master Code</option>
					...
					<td colspan="2">
						...
						<s:iterator value="">
							<tr id="row_<s:property value="id"/>">
								<td>
									<s:property value="assetMasterCode"/>
								</td>
								<td>
									<s:property value="taksasiCode"/>
								</td>
									<td>
									<s:property value="taksasiName"/>
								</td>
								<td>
									<s:property value="taksasiPriceMin"/>
								</td>
								<td>
