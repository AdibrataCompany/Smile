	...
	<div class="container">
		...
		<table width="95%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr>
				...
				<td width="25%" ><input name="textfield32"
					type="text" class="inptype" size="25"></td>
				<td width="25%" >Reference No</td>
				<td width="25%"><input name="textfield3222"
			...
			<tr>
				...
				<td colspan="2" ><input name="textfield322"
			...
			<tr>
				...
				<td colspan="3">IDR <input name="textfield32232" type="text" class="inptype" size="20">
					</div></td>
			</tr>
			...
			<tr>
				<td >Transaction</td>
				<td ><input name="textfield32242" type="text"
				...
				<td >Amount</td>
				<td colspan="2" ><input name="textfield323232"
					type="text" class="inptype" size="20"></td>
			</tr>
			<tr>
				<td valign="top" >Description</td>
				<td colspan="4" ><input name="textfield324"
		...
		<table width="95%" border="0" cellspacing="0" cellpadding="0">
			<tr class="trtopikuning">
				...
				<td align="center" >TRANSACTION DETAIL</td>
				<td width="10" >&nbsp;</td>
			</tr>
		</table>
