...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      <td class="tdgenap">Status Block</td>
      <td class="tdganjil"><asp:DropDownList ID="ddlStatusBlock" runat="server">
      <asp:ListItem text="Select One" Value="0"></asp:ListItem>
...
<p>
<img src="../../Images/Btnrelease.gif" width="100" height="20" border="0" style="float: right"></p>
