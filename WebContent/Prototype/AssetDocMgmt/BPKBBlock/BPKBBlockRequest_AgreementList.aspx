...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopibiru">BPKB BLOCK</td>
  ...
  <table width="100%">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="BPKB NO">
			<ItemStyle HorizontalAlign="Left" />
			<ItemTemplate>
				<asp:Label runat="server" id="lblBPKBNo">xxxxxxxx50xxxxxxxx</asp:label>
			</ItemTemplate>
		</asp:templatefield>
		...
		<asp:templatefield HeaderText="ACTION">
			<ItemStyle HorizontalAlign="Center" />
			<ItemTemplate>
				<asp:HYperlink runat="server" id="hypRequest" ImageUrl="../../Images/iconedit.jpg"  NavigateUrl="BPKBBlockRequest.aspx"/>
			</ItemTemplate>
		</asp:templatefield>
	</Columns>
