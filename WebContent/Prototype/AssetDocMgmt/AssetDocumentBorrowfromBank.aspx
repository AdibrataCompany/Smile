...
<body>
<form runat="server" id="frmAssetDocumentBorrow">
<div align="center"> 
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
      <td colspan="3" style="height: 17px"><font color="red"><i>Funding pledge status 'P' dan asset 
		doc status yang main='Pledge'AND isdocpledgingborrow='No'</i></font></td>
    </tr>

    <tr class="trtopiabu"> 
      <td width="10" height="20" class="tdtopimerahkiri">&nbsp;</td>
      <td align="center" class="tdtopimerah">ASSET DOCUMENT BORROW FROM BANK </td>
  ...
  <div align="center">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="ACTION">
			<ItemStyle HorizontalAlign="Left" />
			<ItemTemplate>
				<asp:HyperLink runat="server" id="lnkCustomer" NavigateUrl="../AssetDocMgmt/AssetDocumentBorrowfromBankProcess.Aspx" Target="_self">Borrow
				</asp:HyperLink>
			</ItemTemplate>
		</asp:templatefield>
	</Columns>
