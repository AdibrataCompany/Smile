...
<div align="center">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopimerah">ASSET DOCUMENT RETURN TO BANK</td>
...
<table width="95%" border="0" cellpadding="3" cellspacing="1" class="tdjudulmerah">
     <tr>
      <td width="100%" align="center"><div align="justify">
          <p class="tdjudulmerah">RETURN TO BANK</p>
        </div></td>
    </tr>
  </table>
 ...
 <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
   <tr> 
      <td width="20%" class="tdgenap">Return t<span class="tdgenap">o </span>Bank Date</td>
      <td width="80%" class="tdganjil" colspan="3"><input name="textfield322422" type="text" class="inptype" size="15"> 
        <img src="../Images/iconcalendar.gif" width="20" height="20" align="absmiddle"></td>
        
  
    </tr>
    <tr> 
  <td width="20%" class="tdgenap">Return to Bank By</td>
      <td width="30%" class="tdganjil"><input name="textfield32243" type="text" class="inptype" size="25"></td>
      
      </tr>
    <tr> 
      <td valign="tdgenap" class="tdgenap">Return Notes</td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
   ...
   <table class="tablegrid" style="width: 95%">
		...
		<td style="width: 197px" class="tdganjil">xxxx20xxxx</td>
		<td style="width: 245px" class="tdganjil">OnHand</td>
		<td style="width: 197px" class="tdganjil">dd/mm/yyyy</td>
		</tr>
	</table>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <asp:ImageButton id="imbSaveExit" imageurl="../Images/ButtonSave.gif" runat="server" PostBackUrl="AssetDocumentReturntobank.aspx"></asp:ImageButton>
		&nbsp;<asp:ImageButton id="imbCancel" imageurl="../Images/ButtonCancel.gif" runat="server" PostBackUrl="AssetDocumentReturntobank.aspx"></asp:ImageButton>
      </td>
    </tr>
  </table>
  <p>&nbsp;</p>
