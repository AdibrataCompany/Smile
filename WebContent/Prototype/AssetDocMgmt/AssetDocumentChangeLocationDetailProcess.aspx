...
<body>
<form runat="server" id="frmAssetDocumentChangeLocationDetailProcess">
<div align="center">
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      ...
      <td class="tdganjil">B 9999 XX</td>
  ...
  <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tdjudulmerah">
     <tr>
      <td width="100%" align="center"><div align="justify">
          <p class="tdjudulmerah">CHANGE LOCATION</p>
        </div></td>
    </tr>
  </table>
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
   <tr> 
      <td width="18%" class="tdgenap">Branch</td>
      <td width="32%" class="tdganjil" colspan="3">
	   <asp:DropDownList runat="server" ID="DDLBranch" CssClass="inptype" AutoPostBack="true">
	     <asp:ListItem Text="Bandung" Selected="True" Value="0"></asp:ListItem>
	     <asp:ListItem Text="Pindah cabang Lain" Value="1"></asp:ListItem>
	   </asp:DropDownList>
	  </td>
	</tr>
	<% if DDLBranch.SelectedValue = "0" Then %>
	<tr> 
      <td width="20%" class="tdgenap">New Rack Location</td>
      <td width="30%" class="tdganjil">
        <asp:DropDownList runat="server" ID="DDLRack1" CssClass="inptype">
          <asp:ListItem Text="Rack 1"></asp:ListItem>
          <asp:ListItem Text="Rack 2"></asp:ListItem>
        </asp:DropDownList>
      
      </td>
      <td class="tdgenap" width="20%">New Filing Location</td>
      <td class="tdganjil" width="30%">
	    <asp:DropDownList runat="server" ID="DDLFilling1" CssClass="inptype">
          <asp:ListItem Text="Filling 1"></asp:ListItem>
          <asp:ListItem Text="Filling 2"></asp:ListItem>
        </asp:DropDownList>
   ...
   <tr> 
      <td width="20%" class="tdgenap">New Rack Location</td>
      <td width="30%" class="tdganjil">
        <asp:DropDownList runat="server" ID="DDLRack2" CssClass="inptype" Enabled="false">
          <asp:ListItem Text="Rack 1"></asp:ListItem>
          <asp:ListItem Text="Rack 2"></asp:ListItem>
        </asp:DropDownList>
      ...
      <td class="tdgenap" width="20%">New Filing Location</td>
      <td class="tdganjil" width="30">
	    <asp:DropDownList runat="server" ID="DDLFilling2" CssClass="inptype" Enabled="false">
          <asp:ListItem Text="Filling 1"></asp:ListItem>
          <asp:ListItem Text="Filling 2"></asp:ListItem>
        </asp:DropDownList>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <asp:ImageButton id="imbSaveExit" imageurl="../Images/ButtonSave.gif" runat="server" PostBackUrl="AssetDocumentChangeLocationDetail.aspx"></asp:ImageButton>
		&nbsp;<asp:ImageButton id="imbCancel" imageurl="../Images/ButtonCancel.gif" runat="server" PostBackUrl="AssetDocumentChangeLocationDetail.aspx"></asp:ImageButton>
      </td>
    </tr>
  </table>
