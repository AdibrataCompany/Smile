...
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right" style="height: 20px"><img src="../Images/ButtonSearch.gif" width="100" height="20" border="0"> 
  ...
  <div align="center">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="ACTION">
			<ItemStyle HorizontalAlign="Left" />
			<ItemTemplate>
				<asp:HyperLink runat="server" id="lnkCustomer" NavigateUrl="../AssetDocMgmt/AssetDocumentReceiveDetail.Aspx" Target="_self">Receive
				</asp:HyperLink>
			</ItemTemplate>
		</asp:templatefield>
	</Columns>
