...
<body>
<form runat="server" id="frmAssetDocumentChangeLocation">
<div align="center">
  ...
  <div align="center">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="ACTION">
			<ItemStyle HorizontalAlign="Left" />
			<ItemTemplate>
				<asp:HyperLink runat="server" id="lnkCustomer" NavigateUrl="../AssetDocMgmt/AssetDocumentChangeLocationDetail.Aspx" Target="_self">Change
				</asp:HyperLink>
			</ItemTemplate>
		</asp:templatefield>
	</Columns>
