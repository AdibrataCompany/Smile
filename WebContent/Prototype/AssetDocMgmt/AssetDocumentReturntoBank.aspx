...
<div align="center"> 
  ...
  <tr> 
      <td colspan="3"><font color="red"><i>Funding pledge status 'P' dan asset 
		doc status yang main='ONHAND' AND isdocpledgingborrow='yes'</i></font></td>
    </tr>
  ...
  <div align="center">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="ACTION">
			<ItemStyle HorizontalAlign="Left" />
			<ItemTemplate>
				<asp:HyperLink runat="server" id="lnkCustomer" NavigateUrl="../AssetDocMgmt/AssetDocumentReturntoBankProcess.Aspx" Target="_self">Return
				</asp:HyperLink>
			</ItemTemplate>
		</asp:templatefield>
	</Columns>
