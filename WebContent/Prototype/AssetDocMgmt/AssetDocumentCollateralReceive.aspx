      ...
      <td  class="tdganjil">
 		  <asp:DropDownList runat="server" ID="DDLDocumentStatus">
 		     ...
 		     <asp:ListItem Text="Waiting"></asp:ListItem>
  		     ...
  		     <asp:ListItem Text="Release"></asp:ListItem>
		</asp:DropDownList>
    </tr>
   </table>
    <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
  ...
  <div align="center">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="ACTION">
			<ItemStyle HorizontalAlign="Left" />
			<ItemTemplate>
				<asp:HyperLink runat="server" id="lnkCustomer" NavigateUrl="../AssetDocMgmt/AssetDocumentCollateralReceiveDetail.Aspx" Target="_self">Receive
				</asp:HyperLink>
			</ItemTemplate>
