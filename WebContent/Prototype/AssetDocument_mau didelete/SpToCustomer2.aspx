...
<body>
<form id="FrmSpToCustomer2" runat="server">
<div align="center"> 
...
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      <td width="10" height="20" class="tdtopimerahkiri">&nbsp;</td>
      <td align="center" class="tdtopimerah">SP BPKB TO CUSTOMER - LISTING</td>
      <td width="10" class="tdtopimerahkanan">&nbsp;</td>
    </tr>
  </table>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		&nbsp;
		<asp:ImageButton runat="server" id="BtnPrint" ImageUrl="../images/ButtonPrint.gif" PostBackUrl="ReportSpBpkbToCustomer.aspx" />&nbsp;
		<asp:ImageButton runat="server" id="BtnSave" ImageUrl="../images/ButtonSave.gif" PostBackUrl="SpToCustomer2.aspx" /></td>
    </tr>
  </table>
</form>
</body>
