...
<body>
<form id="RptBpkbFinishLoanInputParameter" runat="server">
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopimerah">BPKB FINISH LOAN REPORT</td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">&nbsp;<asp:ImageButton runat="server" id="BtnViewReport" ImageUrl="../images/ButtonViewReport.gif" PostBackUrl="RptLapBpkbFinishLoan.aspx" />&nbsp;</td>
    </tr>
  </table>
