...
<body>
<form id="FrmInqPendingAssetDocToFundCompPladge2" runat="server">
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopimerah">INQUIRY PENDING SEND DOCUMENT TO 
		FUNDING COMPANY</td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      <td width="10" height="20" class="tdtopimerahkiri">&nbsp;</td>
      <td align="center" class="tdtopimerah">PENDING SEND DOCUMENT TO FUNDING 
		COMPANY - LISTING</td>
      <td width="10" class="tdtopimerahkanan">&nbsp;</td>
    </tr>
  </table>
  <asp:GridView runat="server" id="GrdViewSpBpkbExtend" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%">
	<Columns>
		...
		<asp:boundfield DataField="valstring50" SortExpression="valstring50" HeaderText="REASON">
			<ItemStyle HorizontalAlign="Left" />
		</asp:boundfield>
	</Columns>
