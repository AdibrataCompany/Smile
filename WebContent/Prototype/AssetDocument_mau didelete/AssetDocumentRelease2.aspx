...
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      <td width="10" height="20" class="tdtopimerahkiri">&nbsp;</td>
      <td align="center" class="tdtopimerah">ASSET DOCUMENT RELEASE - LISTING</td>
      <td width="10" class="tdtopimerahkanan">&nbsp;</td>
    </tr>
  </table>
  <asp:GridView runat="server" id="GrdViewSpBpkbToDealer" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%">
	<Columns>
		...
		<asp:boundfield DataField="valstring30" SortExpression="valstring30" HeaderText="ENGINE NO">
		</asp:boundfield>
		<asp:templatefield HeaderText="ACTION">
			<AlternatingItemTemplate>
				<div class="style1">
					<asp:HyperLink runat="server" id="LinkAction" ImageUrl="../images/IconDocument.gif" NavigateUrl="TandaTerimaDocumentRelease.aspx" Target="_blank">
					</asp:HyperLink>
				</div>
			</AlternatingItemTemplate>
			<ItemTemplate>
