...
aux4 = insFld(aux3, gFld("Non Electronics", null));
...
aux5 = insFld(aux3, gFld("KTA", null));
...
//insDoc(aux3, gLnk(2, "Detail Order In per AO","Marketing/Reports/DetailOrderInPerAO.htm"));
//insDoc(aux3, gLnk(2, "Order & Real by AO","Marketing/Reports/OrderRealByAO.htm"));
...
//aux3 = insFld(aux2, gFld("Negative List", null));
//insDoc(aux3, gLnk(2, "Negative List Internal","Marketing/Reports/NegativeListInternal.htm"));
//insDoc(aux3, gLnk(2, "Negative List External","Marketing/Reports/NegativeListEksternal.htm"));
//aux3 = insFld(aux2, gFld("Customer Data", null));
//insDoc(aux3, gLnk(2, "Personal Customer","Marketing/Reports/PersonalCustomer.htm"));
//insDoc(aux3, gLnk(2, "Company Customer","Marketing/Reports/CompanyCustomer.htm"));
//aux3 = insFld(aux2, gFld("AO Performance", null));
//insDoc(aux3, gLnk(2, "Rank of AO by Sales per Branch","Credit/Reports/RankofAOBranch.htm"));
//insDoc(aux3, gLnk(2, "Rank of AO by Sales per Area","Credit/Reports/RankofAOArea.htm"));
//insDoc(aux3, gLnk(2, "Rank of AO by Sales Nat","Credit/Reports/RankofAONat.htm"));
//insDoc(aux3, gLnk(2, "Rank of AO by Overdue per Branch","Credit/Reports/RankofAOOverdueBranch.htm"));
//insDoc(aux3, gLnk(2, "Rank of AO by Overdue per Area","Credit/Reports/RankofAOOverdueArea.htm"));
//insDoc(aux3, gLnk(2, "Rank of AO by Overdue Nat","Credit/Reports/RankofAOOverdueNat.htm"));
//aux3 = insFld(aux2, gFld("Marketing Package", null));
//insDoc(aux3, gLnk(2, "Daily Sales by POT","Credit/Reports/DailySalesPOT.htm"));
//insDoc(aux3, gLnk(2, "Daily Sales by POT per Supplier","Credit/Reports/DailySalesPOTSupplier.htm"));
//insDoc(aux3, gLnk(2, "Daily Sales by POT per Supplier Nat","Credit/Reports/DailySalesPOTSupplierNat.htm"));
//aux3 = insFld(aux2, gFld("CA Performance", null));
//insDoc(aux3, gLnk(2, "Rank of CA by Sales per Branch","Credit/Reports/RankofCABranch.htm"));
//insDoc(aux3, gLnk(2, "Rank of CA by Sales per Area","Credit/Reports/RankofCAArea.htm"));
//insDoc(aux3, gLnk(2, "Rank of CA by Sales Nat","Credit/Reports/RankofCANat.htm"));
insDoc(aux1, gLnk(2, "Document","Credit/Print.htm"));
//insDoc(aux2, gLnk(2, "Surat Kuasa","Credit/PrintSuratKuasa.htm"));
//insDoc(aux2, gLnk(2, "Slip Setoran Bank","Credit/PrintSSB.htm"));
//insDoc(aux2, gLnk(2, "Kwitansi Uang Muka","Credit/PrintKwitansi.htm"));
aux2 = insFld(aux1, gFld("Setting", null));
...
//aux3 = insFld(aux2, gFld("Additional Process", null));
//insDoc(aux3, gLnk(2, "Change Payment Location",""));
...
//insDoc(aux3, gLnk(2, "Payment Listing To Bank Report","Finance/AccountPayable/Report/UserValidasiPaymentListingToBank.aspx"));
//insDoc(aux3, gLnk(2, "Status AP Payment Dealer Report","Finance/AccountPayable/Report/RptStatusApPaymentToDealerInputParameter.aspx"));
...
insDoc(aux3, gLnk(2, "Calculation","AccMaintenance/PrepaymentCalculation.htm"));
insDoc(aux3, gLnk(2, "Request","AccMaintenance/AgreementPrepayment.htm"));
insDoc(aux3, gLnk(2, "Approval","AccMaintenance/PrepaymentApproval.htm"));
insDoc(aux3, gLnk(2, "Execution","AccMaintenance/PrepaymentExecution.htm"));
insDoc(aux3, gLnk(2, "Inquiry","AccMaintenance/PrepaymentInquiry.htm"));
...
//aux2 = insFld(aux1, gFld("STNK Renewal", null));
//insDoc(aux2, gLnk(2, "Request STNK Renewal", "AccMaintenance/RequestSTNKRenewal.htm"));
//insDoc(aux2, gLnk(2, "STNK Renewal Registration", "AccMaintenance/STNKRegistration.htm"));
//insDoc(aux2, gLnk(2, "STNK Renewal Invoicing", "AccMaintenance/STNKInvoicing.htm"));
//aux3 = insFld(aux2, gFld("STNK Renewal Inquiry", null));
//insDoc(aux3, gLnk(2, "STNK Renewal Request", "AccMaintenance/STNKInquiry.htm"));
//insDoc(aux3, gLnk(2, "STNK Renewal Register", "AccMaintenance/STNKRegisterInquiry.htm"));
//insDoc(aux2, gLnk(2, "STNK Agent Maintenance", "AccMaintenance/AgentSTNK.htm"));
...
insDoc(aux1, gLnk(2, "Endorsment Customer","Insurance/EndorsmentRequest.htm"));
...
insDoc(aux1, gLnk(2, "New Cover For Existing Application","Insurance/NewCoverForExistingApp.aspx"));
...
insDoc(aux2, gLnk(2, "Insurance Standard Rate","Insurance/InsuranceStandardPremium.aspx"));
...
insDoc(aux2, gLnk(2, "Kwitansi Collector","Collection/FormControl/FormKwintansiCollector.aspx"));
...
insDoc(aux2, gLnk(2, "Flow Rate Report ","Collection/Report/RptFlowReportInputParameter.aspx"));aux1 = insFld(foldersTree, gFld('AR Monitoring', null));
