...
<div align="center"> 
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopihijau">PENDING T/C</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      ...
      <td width="25%" class="tdgenap">Appication Step</td>
      <td  class="tdganjil">
 		  <asp:DropDownList runat="server" ID="ddlApplicationStep">
 		     <asp:ListItem Text="All"></asp:ListItem>
 		     <asp:ListItem Text="NAP"></asp:ListItem>
   		     <asp:ListItem Text="CSR"></asp:ListItem>
 		     <asp:ListItem Text="RCA"></asp:ListItem>
 		     <asp:ListItem Text="PO"></asp:ListItem>
  		     <asp:ListItem Text="DO"></asp:ListItem>
    ...
    <tr> 
      ...
      <td  class="tdganjil">
 		  <asp:DropDownList runat="server" ID="DDLContractStatus">
 		     <asp:ListItem Text="All"></asp:ListItem>
 		     <asp:ListItem Text="PRP"></asp:ListItem>
   		     <asp:ListItem Text="LIV"></asp:ListItem>
 		     <asp:ListItem Text="RRD"></asp:ListItem>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">&nbsp;<asp:ImageButton runat="server" id="BtnSearch" ImageUrl="../../images/ButtonSearch.gif" PostBackUrl="PendingTC.aspx" />&nbsp;
		<asp:ImageButton runat="server" id="BtnReset" ImageUrl="../../images/ButtonReset.gif" PostBackUrl="PendingTC.aspx" />&nbsp;</td>
    </tr>
  </table>
...
<div align="center"> 
  ...
  <asp:GridView runat="server" id="GrdViewSpBpkbToDealer" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%">
	<Columns>
		<asp:boundfield DataField="valstring20" SortExpression="valstring20" HeaderText="BRANCH NAME">
		...
		<asp:boundfield DataField="valstring3" SortExpression="valstring3" HeaderText="APPLICATION STEP">
		<ItemStyle HorizontalAlign="Center" Width="5%"/>

		</asp:boundfield>

		<asp:boundfield DataField="valstring3" SortExpression="valstring3" HeaderText="CONTRACT STATUS">
		<ItemStyle HorizontalAlign="Center" Width="5%"/>
</asp:boundfield>
		...
		<asp:templatefield HeaderText="ACTION">
			<AlternatingItemTemplate>
				<div class="style1">
					<asp:HyperLink runat="server" id="LinkAction" ImageUrl="../../images/IconDocument.gif" NavigateUrl="AgreementAdditionalTCList.aspx" Target="_self">
					</asp:HyperLink>
				</div>
			</AlternatingItemTemplate>
			<ItemTemplate>
				<div class="style1">
					<asp:HyperLink runat="server" id="LinkAction" ImageUrl="../../images/IconDocument.gif" NavigateUrl="PendingTCList.aspx" Target="_self">
					</asp:HyperLink>
				</div>
			</ItemTemplate>
		</asp:templatefield>
