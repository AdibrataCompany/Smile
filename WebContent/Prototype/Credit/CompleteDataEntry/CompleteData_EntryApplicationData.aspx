...
<div align="center"> 
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <table width="95%">
	 <tr> 
	      <td colspan="4" class="tdjudulhijau">APPLICATION DATA <font color="red">*)</font></td>
	    </tr>
	</table>
  ...
  <td class="tdgenap">Marketing</td>
	...
	<tr>
	 <td class="tdgenap">Repeat Order Quality</td>
      <td class="tdganjil" colspan="3"><asp:label id="lblCustomerRate" text="Regular" runat="server" width="100"></asp:label> 
		</td>
    </tr>
    </table>
    	<table width="95%">
    ...
    <table width="95%" align="center"  border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
      <td class="tdgenap" width="20%">Product Offering</td>
      <td class="tdganjil" colspan="3"> 
	<asp:label id="lblProductOffering" runat="server" width="50%" Text="xxxxxxxxxxx50xxxxxxxxxxx"></asp:label>
	</td>
    </tr>
    <tr> 
      <td class="tdgenap">Tenor</td>
      <td class="tdganjil" colspan="3"><asp:label id="txtTenor" runat="server" Text="99" ></asp:label></td>
    </tr>
    <tr>
    <td class="tdgenap">Payment Frequency</td>
      <td class="tdganjil" colspan="3"><asp:Label id="ddlPaymentFrequency" runat="server" text="xxxxx10xxxx"></asp:Label>
	</td>

    </tr>
    <tr> 
      <td class="tdgenap" style="height: 24px">Interest Type</td>
      <td class="tdganjil" style="height: 24px"><asp:Label id="lblInterestType" runat="server" text="Fixed Rate"></asp:Label>
</td>
    </tr>
    <tr> 
      <td class="tdgenap">Installment Scheme</td>
      <td class="tdganjil">
      <asp:Label id="lblInstallmentScheme" runat="server" text="Regular Installment"></asp:Label></td>
    </tr>
    <tr>
      <td class="tdgenap" style="height: 24px">Step Up Step Down Type</td>
      <td class="tdganjil" style="height: 24px">
      <asp:Label id="lblStepUpStepDownType" runat="server" text="Normal"></asp:Label>
 </td>
    </tr>
    <tr> 
      <td class="tdgenap">Currency</td>
      <td class="tdganjil"> <asp:Label id="lblCurrency" runat="server" text="IDR"></asp:Label></td>
    </tr>
  </table>
 <table>
 <table width="95%">
...
<BR>
    ...
    <tr> 
      ...
      <td width="80%" align="right"><asp:ImageButton id="imbSavePersonalCustomerSurveyReport" imageurl="../../Images/ButtonNext.gif"  PostBackUrl="CompleteData_EntryAssetData.aspx" runat="server"></asp:ImageButton>
		<asp:ImageButton id="imbCancelPersonalCustomerSurveyReport" PostBackUrl="CompleteDataEntryList.aspx" imageurl="../../Images/ButtonCancel.gif" runat="server"></asp:ImageButton>
      </td>
    </tr>
  </table>
</form>
