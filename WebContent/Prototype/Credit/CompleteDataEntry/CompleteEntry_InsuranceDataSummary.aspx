...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      ...
      <td class="tdganjil">
		<asp:Label runat="server" id="lblAdminFee" Text="9,999,999,999"></asp:Label ></td>
      <td class="tdgenap">Stamp Duty Fee</td>
      <td class="tdganjil">
		<asp:Label runat="server" id="lblStampDutyFee" Text="9,999,999,999"></asp:Label ></td>
    </tr>
   ...
   <tr> 
      ...
      <td class="tdganjil" >
		<asp:Label runat="server" id="lblPaidAmountByCustomer" Text="9,999,999,999"></asp:Label ></td>
  ...
  <table width="95%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      ...
      <asp:ImageButton id="imbSaveEntryInsurance" imageurl="../../Images/ButtonNext.gif" postbackurl="CompleteData_OtherData.aspx" runat="server"></asp:ImageButton>
