...
<div align="center">
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopihijau">COMPLETE DATA - OTHER DATA</td>
...
<br>
    ...
    <tr class="trtopikuning"> 
 	...
 	<tr> 
      ...
      <td class="tdganjil" width="30%"><asp:Label ID="lblFinancePurpose" runat="server" Text="Productive"> </asp:Label>
      <td  class="tdgenap"><asp:Label ID="lblDescriptionFinancePurpose" runat="server" textmode="MultiLine" CssClass="inptype" Width="263px" Height="41px"></asp:Label></td>

		</tr>
	  <tr>
      <td width="20%" class="tdgenap">Usage Unit Purpose</td>
      <td class="tdganjil"><asp:Label ID="lblUsageUnitPurpose" runat="server" Text="Pribadi"> </asp:Label>
       <td  class="tdgenap"><asp:Label ID="lblDescriptionUsageUnitPurpose" runat="server" CssClass="inptype" Width="263px" Height="41px"></asp:Label>
       </td>
    </tr>
    </table>
    <br>
 ...
 <table width="95%" border="0" cellspacing="0" cellpadding="0">
  ...
  <asp:GridView runat="server" id="grdDocmentCapacity" AllowSorting="true" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="100%" >
    <Columns>
...
<td>
 <asp:GridView runat="server" id="grdCollateralCoverage" AllowSorting="true" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="100%" >
    ...
    <tr class="trtopikuning"> 
      <td width="10" height="20" class="tdtopihijaukiri">&nbsp;</td>
      <td align="center" class="tdtopihijau">SK USSAGE</td>
      <td width="10" class="tdtopihijaukanan">&nbsp;</td>
    </tr>
  </table>
	<table align="center" width="95%">
	<tr> 
      <td width="20%" class="tdgenap">SK Ussage Description</td>
      <td class="tdganjil" >
		<asp:textbox ID="txtSKUssage" runat="server" TextMode="MultiLine"   CssClass="inptype" Width="523px"></asp:textbox></td>
    </tr>
	</table>
