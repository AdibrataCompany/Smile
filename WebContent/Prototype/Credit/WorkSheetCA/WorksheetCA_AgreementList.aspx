    ...
    <tr> 
      ...
      <td class="tdganjil" >
      	<asp:dropdownlist id="ddlSearchBy" runat="server" >
			<asp:ListItem Text="Application ID" Value="ApplicationID"></asp:ListItem>
  ...
  <asp:GridView runat="server" id="GrdListCustomer" AllowSorting="true" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%" >
    ...
    <asp:templatefield HeaderText="APPLICATION ID" SortExpression="ApplicationID">
		...
		<asp:templatefield HeaderText="ACTION">
			<ItemTemplate>
					<asp:HyperLink runat="server" id="lnkNewApplication" NavigateUrl="WotksheetCA.aspx" Target="_self" ImageUrl="../../Images/IconActivity.gif">
			</asp:HyperLink>
