...
<form id="frmCustomerComplainList" runat="server">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopihijau">PURCHASE ORDER</td>
 ...
 <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right"><asp:ImageButton id="imbSearchPO" imageurl="../Images/ButtonSearch.gif" runat="server" PostBackUrl="PurchaseOrder.aspx"></asp:ImageButton>
		<asp:ImageButton id="imbResetPO" imageurl="../Images/ButtonReset.gif" runat="server"  PostBackUrl="PurchaseOrder.aspx"></asp:ImageButton>
      </td>
    </tr>
  </table>
  <br>
  ...
  <div align="center">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="ACTION">
			<AlternatingItemTemplate>
				<asp:HyperLink runat="server" id="hypPurchaseOrder" NavigateUrl="PurchaseOrderProcess.aspx" Target="_self">Purchase Order</asp:HyperLink>
			</AlternatingItemTemplate>
			<ItemTemplate>
				<asp:HyperLink runat="server" id="hypPurchaseOrder" NavigateUrl="PurchaseOrderProcess.aspx" Target="_self">Purchase Order</asp:HyperLink>
			</ItemTemplate>
