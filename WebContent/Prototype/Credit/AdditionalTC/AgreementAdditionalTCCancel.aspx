...
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      <td width="10" height="20" class="tdtopihijaukiri">&nbsp;</td>
      <td align="center" class="tdtopihijau">AGREEMENT ADDITIONAL T/C - CANCEL</td>
      <td width="10" class="tdtopihijaukanan">&nbsp;</td>
    </tr>
  </table>
  <div align="center">
...
&nbsp;*)</font> </td>
         ...
         <tr> 
          ...
          <td class="style2"><font color="red">
			<asp:TextBox runat="server" id="txtTermConditionName" Width="315px" CssClass="inptype" Enabled="false" Text="xxxxx50xxxxx">
			</asp:TextBox >
&nbsp;*)</font> </td>
        </tr>
        <tr> 
          ...
          <td class="style2">
			<asp:DropDownList runat="server" id="CmbPriorTo" CssClass="inptype" Enabled="false">
        ...
        <tr> 
          ...
          <td class="style2">
			<asp:RadioButtonList runat="server" id="RdBtnYes" RepeatDirection="Horizontal" Enabled="false">
			<asp:ListItem Text="Yes" Checked="True"></asp:ListItem>
         ...
         <tr> 
          ...
          <td class="style2">
			<asp:TextBox runat="server" ID="Notes" CssClass="inptype" Rows="5" Columns="50" TextMode="MultiLine"></asp:TextBox>
			</td>
        </tr>
