...
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      <td width="10" height="20" class="tdtopihijaukiri">&nbsp;</td>
      <td align="center" class="tdtopihijau">AGREEMENT ADDITIONAL T/C - ADD</td>
      <td width="10" class="tdtopihijaukanan">&nbsp;</td>
    </tr>
  </table>
  <div align="center">
      ...
      <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tablegrid">
        <tr> 
          ...
          <td class="style2"><font color="red">
			<asp:TextBox runat="server" id="txtTermConditionID" CssClass="inptype">
			</asp:TextBox >
&nbsp;*)</font> </td>
        </tr>
         <tr> 
          ...
          <td class="style2"><font color="red">
			<asp:TextBox runat="server" id="txtTermConditionName" Width="315px" CssClass="inptype">
			</asp:TextBox >
&nbsp;*)</font> </td>
        </tr>
