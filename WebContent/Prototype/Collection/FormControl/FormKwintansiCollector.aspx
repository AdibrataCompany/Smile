...
<html>
<head>
<title>Form Kwitansi Collector</title>
...
<body>
<form id="FrmKwitansiCollector" runat="server">
<div align="center">
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
 	<tr class="trtopikuning"> 

      <td align="center" class="tdtopihijau" colspan="2">KWITANSI COLLECTOR</td>
      <tr> 
      ...
      <td width="86%" class="tdganjil">
       <asp:DropDownList runat="server" id="DDLAddress0">
		<asp:ListItem Value="FormNo">Kwitansi No</asp:ListItem>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopihijau">KWITANSI COLLECTOR LISTING</td>
  ...
  <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tablegrid">
    <tr align="center" class="tdjudulungu"> 
      <td><a href="AddressMaintenance.htm">K<span class="style1">WINTANSI NO</span></a></td>
