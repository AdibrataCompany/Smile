	...
	<body>
		<form id="Form1" method="post" runat="server">
		    ...
		    <tr class="trtopiungu"> 
		      ...
		      <td align="center" class="tdtopiungu">ACTION - ADD</td>
		      <td width="10" class="tdtopiungukanan">&nbsp;</td>
				...
				<TABLE class="tablegrid" id="Table7" cellSpacing="1" cellPadding="2" width="95%" align="center"
					...
					<TR class="tdganjil">
						...
						<TD class="tdganjil">
							<asp:TextBox id="txtActionID" runat="server" CssClass="InpType" MaxLength="10"></asp:TextBox>
					...
					<TR class="tdganjil">
						...
						<TD class="tdganjil">
							<asp:TextBox id="txtActionName" runat="server" CssClass="InpType" MaxLength="100"></asp:TextBox>
