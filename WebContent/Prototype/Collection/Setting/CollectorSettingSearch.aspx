...
<div align="center">
  ...
  <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tablegrid">
    ...
    <tr class="tdganjil"> 
      <td width="15%">
		<asp:HyperLink runat="server" id="LinkCollectorId" NavigateUrl="../CollMacet/ViewCollector.htm" Target="_blank">xxxxx12xxxxx
		</asp:HyperLink>
		</td>
    ...
    <tr class="tdgenap"> 
      <td width="15%">
		<asp:HyperLink runat="server" id="LinkCollectorId0" NavigateUrl="../CollMacet/ViewCollector.htm" Target="_blank">xxxxx12xxxxx
		</asp:HyperLink>
		</td>
      <td>xxxxxxxx50xxxxxxxx</td>
      <td class="style1">xxxxx20xxxxx</td>
    ...
    <tr class="tdganjil"> 
      <td height="24" width="15%">
		<asp:HyperLink runat="server" id="LinkCollectorId1" NavigateUrl="../CollMacet/ViewCollector.htm" Target="_blank">xxxxx12xxxxx
		</asp:HyperLink>
		</td>
      <td>xxxxxxxx50xxxxxxxx</td>
      <td class="style1">xxxxx20xxxxx</td>
    ...
    <tr class="tdgenap"> 
      <td width="15%">
		<asp:HyperLink runat="server" id="LinkCollectorId2" NavigateUrl="../CollMacet/ViewCollector.htm" Target="_blank">xxxxx12xxxxx
		</asp:HyperLink>
		</td>
      <td>xxxxxxxx50xxxxxxxx</td>
      <td class="style1">xxxxx20xxxxx</td>
    ...
    <tr class="tdganjil"> 
      <td width="15%">
		<asp:HyperLink runat="server" id="LinkCollectorId3" NavigateUrl="../CollMacet/ViewCollector.htm" Target="_blank">xxxxx12xxxxx
		</asp:HyperLink>
		</td>
      <td>xxxxxxxx50xxxxxxxx</td>
      <td class="style1">xxxxx20xxxxx</td>
    ...
    <tr class="tdgenap"> 
      <td width="15%">
		<asp:HyperLink runat="server" id="LinkCollectorId4" NavigateUrl="../CollMacet/ViewCollector.htm" Target="_blank">xxxxx12xxxxx
		</asp:HyperLink>
		</td>
      <td>xxxxxxxx50xxxxxxxx</td>
      <td class="style1">xxxxx20xxxxx</td>
    ...
    <tr class="tdganjil"> 
      <td width="15%">
		<asp:HyperLink runat="server" id="LinkCollectorId5" NavigateUrl="../CollMacet/ViewCollector.htm" Target="_blank">xxxxx12xxxxx
		</asp:HyperLink>
		</td>
      <td>xxxxxxxx50xxxxxxxx</td>
      <td class="style1">xxxxx20xxxxx</td>
    ...
    <tr class="tdgenap"> 
      <td width="15%">
		<asp:HyperLink runat="server" id="LinkCollectorId6" NavigateUrl="../CollMacet/ViewCollector.htm" Target="_blank">xxxxx12xxxxx
		</asp:HyperLink>
		</td>
      <td>xxxxxxxx50xxxxxxxx</td>
      <td class="style1">xxxxx20xxxxx</td>
    ...
    <tr class="tdganjil"> 
      <td width="15%">
		<asp:HyperLink runat="server" id="LinkCollectorId7" NavigateUrl="../CollMacet/ViewCollector.htm" Target="_blank">xxxxx12xxxxx
		</asp:HyperLink>
		</td>
      <td>xxxxxxxx50xxxxxxxx</td>
      <td class="style1">xxxxx20xxxxx</td>
    ...
    <tr class="tdgenap"> 
      <td width="15%"><a href="javascript:;" onClick="MM_openBrWindow('ViewCollector.htm','Collector','scrollbars=yes,width=900,height=500')">xxxxx12xxxxx</a></td>
      <td>xxxxxxxx50xxxxxxxx</td>
      <td class="style1">xxxxx20xxxxx</td>
      <td align="center">x</td>
      <td align="center">&nbsp;</td>
