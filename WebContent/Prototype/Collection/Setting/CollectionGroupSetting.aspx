...
<div align="center">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopiungu">COLLECTION GROUP </td>
    ...
    <tr> 
      ...
      <td width="80%" class="tdganjil" colspan=3> 
        <select name="select14">
          <option selected>Collection Group Id</option>
          <option>Collection Group Name</option>
        </select>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      <td width="10" height="20" class="tdtopiungukiri">&nbsp;</td>
      <td align="center" class="tdtopiungu">COLLECTION GROUP LISTING</td>
      <td width="10" class="tdtopiungukanan">&nbsp;</td>
    </tr>
  </table>
   <div align="center">
    ...
    <Columns>
		<asp:templatefield SortExpression="valstring20" HeaderText="COLLECTION GROUP ID">
		...
		<asp:boundfield DataField="valstring50" SortExpression="valstring50" HeaderText="COLLECTION GROUP NAME">
		...
		<asp:boundfield DataField="valstring50" SortExpression="valstring50" HeaderText="COLLECTION GROUP HEAD">
		</asp:boundfield>
		<asp:templatefield HeaderText="COLLECTION GROUP MEMBER">
			<ItemStyle HorizontalAlign="Center"></ItemStyle>
			<ItemTemplate>
				<asp:ImageButton id="ImbEdit" runat="server" ImageUrl="../../Images/iconedit.gif" PostBackUrl="CollectionGroupSettingMember.aspx"></asp:ImageButton>
			</ItemTemplate>
			</asp:templatefield >
		...
		<asp:templatefield HeaderText="EDIT">
			<ItemStyle HorizontalAlign="Center"></ItemStyle>
			<ItemTemplate>
				<asp:ImageButton id="ImbEdit" runat="server" ImageUrl="../../Images/iconedit.gif" PostBackUrl="CollectionGroupSettingEdit.aspx"></asp:ImageButton>
			</ItemTemplate>
			</asp:templatefield >
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="50%" height="30"><a href="../Report/RptCollGroup.htm"><img src="../../Images/ButtonPrint.gif" width="100" height="20" border="0"></a></td>
      <td width="50%" align="right"><a href="CollectionGroupSettingAdd.aspx"><img src="../../Images/ButtonAdd.gif" width="100" height="20" border="0"></a> 
      </td>
    </tr>
  </table>
