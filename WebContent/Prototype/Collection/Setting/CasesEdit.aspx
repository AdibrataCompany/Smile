...
<body>
<form id="FrmCasesEdit" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopiungu">CASES - EDIT</td>
...
&nbsp;xxxxx10xxxxx</td>
    ...
    <tr> 
      ...
      <td class="style1">
		<asp:TextBox runat="server" id="TbsCasesDescription" Width="287px" CssClass="inptype">xxxxxxxx50xxxxxxxx</asp:TextBox>
