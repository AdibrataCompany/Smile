...
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopiungu">COLLECTION ISLAND - MEMBER</td>
...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      <td width="10" height="20" class="tdtopiungukiri">&nbsp;</td>
      <td align="center" class="tdtopiungu">COLLECTION ISLAND MEMBER LISTING</td>
      <td width="10" class="tdtopiungukanan">&nbsp;</td>
    </tr>
  </table>
   <div align="center">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="COLLECTION GROUP ID">
			<ItemStyle HorizontalAlign="Left" />
			<ItemTemplate>
				<asp:HyperLink runat="server" id="lnkBranch" NavigateUrl="../Credit/ViewBranch.htm" Target="_blank">xxxxxxxx50xxxxxxxx
				</asp:HyperLink>
			</ItemTemplate>
		</asp:templatefield>
