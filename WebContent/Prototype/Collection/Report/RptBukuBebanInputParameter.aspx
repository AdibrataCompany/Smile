...
<body>
<form id="FrmBukuBebanInputParameter" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopiungu">BUKU BEBAN REPORT</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr>
      <td class="style2" style="width: 28%">Collector Name</td>
      <td class="style1">
		<asp:DropDownList runat="server" id="CmbCollectorName" CssClass="inptype">
	        <asp:ListItem>Select One</asp:ListItem>							
		</asp:DropDownList>
		&nbsp;<span class="style4">*)</span></td>
    </tr>
...
&nbsp;
		<asp:TextBox runat="server" id="TextBox1" Width="79px" CssClass="inptype">
		</asp:TextBox>
&nbsp;&nbsp; *)</span></td>
    </tr>
    <tr> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		&nbsp;&nbsp;&nbsp; 
        <asp:ImageButton runat="server" id="BtnViewReport" ImageUrl="../../images/ButtonViewReport.gif" PostBackUrl="ReportBukuBeban.aspx" />&nbsp;</td>
    </tr>
  </table>
</div>
</form>
