...
<body>
<form id="FrmRptPerformanceReview" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopiungu">PERFORMANCE REVIEW&nbsp; REPORT</td>
    ...
    <tr> 
      ...
      <td class="style1">
		<asp:DropDownList runat="server" id="CmbCollectionCategory" CssClass="inptype">
			...
			<asp:ListItem>Field Coll 1</asp:ListItem>
			<asp:ListItem>Field Coll 2</asp:ListItem>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		&nbsp;&nbsp;&nbsp; 
        <asp:ImageButton runat="server" id="BtnViewReport" ImageUrl="../../images/ButtonViewReport.gif" PostBackUrl="ReportPerformanceReview.aspx" />&nbsp;</td>
    </tr>
  </table>
</div>
</form>
