...
<body>
<form id="FrmAnalisaKasusInputParameter" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopiungu">FORM ANALISA KASUS</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr>
      <td class="style2" style="width: 28%">Agreement No</td>
      <td class="style1">
		<asp:TextBox runat="server" id="TbsAgreementNo" CssClass="inptype" Width="248px">
		</asp:TextBox>
&nbsp;
		&nbsp;<asp:HyperLink runat="server" id="LinkDetail" ImageUrl="../../images/IconDetail.gif" NavigateUrl="../../LookUp/AgreementLookUp.aspx" Target="_blank">
		</asp:HyperLink>
		&nbsp;&nbsp; <span class="style4">*)</span></td>
    </tr>
    </table>
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		&nbsp;&nbsp;&nbsp; 
        <asp:ImageButton runat="server" id="BtnViewReport" ImageUrl="../../images/ButtonViewReport.gif" PostBackUrl="FrmAnalisaKasus.aspx" />&nbsp;</td>
    </tr>
  </table>
</div>
</form>
