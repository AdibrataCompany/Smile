...
<body>
<form id="FrmSummaryActivityCollInputParameter" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopiungu">SUMMARY ACTIVITY COLLECTOR REPORT</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr>
      <td class="style2" style="width: 28%">Collection Category</td>
      <td class="style1">
		<asp:DropDownList runat="server" id="CmbCollectionCategory" CssClass="inptype">
	        <asp:ListItem>Select One</asp:ListItem>	
			<asp:ListItem>Desk Coll</asp:ListItem>
			<asp:ListItem>Field Collector 1</asp:ListItem>
			<asp:ListItem>Field Collector 2</asp:ListItem>
			<asp:ListItem>Remedial</asp:ListItem>						
		</asp:DropDownList>
		&nbsp;<span class="style4">*)</span></td>
    </tr>
    <tr>
      <td class="style2" style="width: 28%">Activity Period</td>
      <td class="style1">
		<span class="style4">
		<asp:TextBox runat="server" id="TbdPeriodeFrom" Width="120px" CssClass="inptype">
		</asp:TextBox>
		...
		<asp:TextBox runat="server" id="TbdPeriodeTo" Width="120px" CssClass="inptype">
		</asp:TextBox>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		&nbsp;&nbsp;&nbsp; 
        <asp:ImageButton runat="server" id="BtnViewReport" ImageUrl="../../images/ButtonViewReport.gif" PostBackUrl="ReportSummaryActivityCollector.aspx" />&nbsp;</td>
    </tr>
  </table>
</div>
</form>
