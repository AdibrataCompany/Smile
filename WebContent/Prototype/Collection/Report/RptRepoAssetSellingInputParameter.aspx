...
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopiungu">REPOSSESS ASSET SELLING REPORT</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      <td class="style2" style="width: 28%">Sales Date Period</td>
      <td class="style1">
		<span class="style4">
		<asp:TextBox runat="server" id="TbdSalesPeriodeFrom" Width="120px" CssClass="inptype">
		</asp:TextBox>
		...
		<asp:TextBox runat="server" id="TbdSalesPeriodeTo" Width="120px" CssClass="inptype">
		</asp:TextBox>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		&nbsp;&nbsp;&nbsp; 
        <asp:ImageButton runat="server" id="BtnViewReport" ImageUrl="../../images/ButtonViewReport.gif" PostBackUrl="ReportRepossedAssetSelling.aspx" />&nbsp;</td>
    </tr>
  </table>
</div>
</form>
