...
<body>
<form id="FrmRptRepossessAssetInputParameter" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopiungu">REPOSSESS ASSET BY PERIODE REPORT</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      ...
      <td class="style1">
		<asp:DropDownList runat="server" id="CmbType" CssClass="inptype">
	        <asp:ListItem>Select One</asp:ListItem>	
    ...
    <tr> 
      <td class="style2" style="width: 28%">Periode</td>
      <td class="style1">
		<span class="style4">
    ...
    <tr>
      <td class="style2" style="width: 28%">Option</td>
      <td class="style1">
		<asp:DropDownList runat="server" id="CmbOption" CssClass="inptype">
	        <asp:ListItem>All</asp:ListItem>	
			<asp:ListItem>FPD</asp:ListItem>				
			<asp:ListItem>Non FPD</asp:ListItem>
		</asp:DropDownList>
		&nbsp;<span class="style4">**)</span></td>
    </tr>
    </table>
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		&nbsp;&nbsp;&nbsp; 
        <asp:ImageButton runat="server" id="BtnViewReport" ImageUrl="../../images/ButtonViewReport.gif" PostBackUrl="ReportRepossedAssetPeriod.aspx" />&nbsp;</td>
    </tr>
  </table>
</div>
</form>
