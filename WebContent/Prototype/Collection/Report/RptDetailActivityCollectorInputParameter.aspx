...
<body>
<form id="FrmDetailActivityCollInputParameter" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopiungu">DETAIL ACTIVITY COLLECTOR REPORT</td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		&nbsp;&nbsp;&nbsp; 
        <asp:ImageButton runat="server" id="BtnViewReport" ImageUrl="../../images/ButtonViewReport.gif" PostBackUrl="ReportDetailActivityCollector.aspx" />&nbsp;</td>
    </tr>
  </table>
</div>
</form>
