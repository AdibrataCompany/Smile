...
<div align="center">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopiungu">PRINT RAL PRINTING</td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="50%" height="30" class="style3">
		<asp:HyperLink runat="server" id="LinkPrintRAL" ImageUrl="../../images/ButtonPrint.gif" NavigateUrl="ReportSuratTugas.aspx" Target="_blank">
		</asp:HyperLink>
&nbsp;</td>
