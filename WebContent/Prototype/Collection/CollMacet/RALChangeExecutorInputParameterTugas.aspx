...
<div align="center">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopiungu">PRINT CHANGE EXECUTOR</td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="50%" height="30" class="style3">
		<asp:HyperLink runat="server" id="LinkPrintRAL" ImageUrl="../../images/ButtonPrint.gif" NavigateUrl="ReportSuratKuasa.aspx" Target="_blank">
		</asp:HyperLink>
&nbsp;</td>
      <td width="50%" align="right">
		&nbsp; 
        <asp:ImageButton runat="server" id="BtnBack" ImageUrl="../../images/ButtonBack.gif" PostBackUrl="SKTPrintingSearch.aspx" />&nbsp;</td>
    </tr>
  </table>
</div>
</form>
