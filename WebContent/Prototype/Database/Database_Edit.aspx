...
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopihijau">DATABANK - EDIT</td>
   ...
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
  		<asp:ImageButton id="imbSaveEditDataBank" imageurl="../Images/ButtonSave.gif" postbackurl="Database_List.aspx" runat="server"></asp:ImageButton>
		<asp:ImageButton id="imbCancelEditDataBank" runat="Server" postbackurl="Database_List.aspx" imageurl="../Images/ButtonCancel.gif"></asp:ImageButton>
      </td>
    </tr>
  </table>
  </div>
