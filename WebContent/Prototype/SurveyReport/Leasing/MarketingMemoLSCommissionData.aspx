...
<asp:XmlDataSource runat="server" ID="XmlDataSource1" DataFile="../../DataType.xml">
  ...
  <table width="95%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <asp:ImageButton id="imbCalculateEntryCommission" imageurl="../../Images/ButtonCalculate.gif" postbackurl="MarketingMemoLSCommissionDataDetail.aspx" runat="server"></asp:ImageButton>
        <asp:ImageButton ID="imbCancelEntryCommission" runat="server" PostBackUrl="MarketingMemoLS5.aspx" ImageUrl="../../Images/ButtonCancel.gif"></asp:ImageButton>
