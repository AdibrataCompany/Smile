...
<div align="center"> 
  ...
  <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      ...
      <td width="50%" align="right"><asp:ImageButton id="imbSavePersonalCustomerSurveyReportDEMotor" imageurl="../Images/ButtonNext.gif" postbackurl="DEMotor/SurveyReportDEMotor.aspx" runat="server"></asp:ImageButton>
   ...
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="50%" height="30">&nbsp;</td>
      <td width="50%" align="right"><asp:ImageButton id="imbSavePersonalCustomerSurveyReportLeasing" imageurl="../Images/ButtonNext.gif" postbackurl="Leasing/SurveyReport_Leasing.aspx" runat="server"></asp:ImageButton>
   ...
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="50%" height="30">&nbsp;</td>
      <td width="50%" align="right"><asp:ImageButton id="imbSavePersonalCustomerSurveyReportCF" imageurl="../Images/ButtonNext.gif" postbackurl="CF/PersonalCustomer_Add_KCM.aspx" runat="server"></asp:ImageButton>
