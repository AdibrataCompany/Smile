  ...
  <asp:GridView runat="server" id="GrdListCustomer" AllowSorting="true" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%" >
    ...
    <asp:templatefield HeaderText="APPLICATION ID" SortExpression="ApplicationID">
		...
		<asp:templatefield HeaderText="ACTION">
			<AlternatingItemTemplate>
					<asp:HyperLink runat="server" id="lnkNewApplication" NavigateUrl="SurveyReport_CF_AssetList.aspx" Target="_self">Entry Asset
				</asp:HyperLink>

			</AlternatingItemTemplate>
			<ItemTemplate>
					<asp:HyperLink runat="server" id="lnkNewApplication" NavigateUrl="SurveyReport_CF_AssetList.aspx" Target="_self">Entry Asset				</asp:HyperLink>
