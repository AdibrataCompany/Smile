...
<div align="center">
 <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopihijau">SURVEY REPORT - ENTRY INSURANCE DATA</td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="INSURANCE" HeaderStyle-HorizontalAlign="Center">
			<ItemTemplate>
				<asp:HyperLink runat="server" id="hypInputInsurance" NavigateUrl="SurveyReport_CF_InsuranceData.aspx" Target="_self">Insurance
				</asp:HyperLink>
			</ItemTemplate>
