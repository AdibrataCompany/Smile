...
<div align="center"> 
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopihijau">SURVEY REPORT DE MOTOR - ENTRY 
		ASSET</td>
    ...
    <tr> 
      ...
      <td class="tdganjil" >
      	<asp:dropdownlist id="ddlSearchBy" runat="server" >
			<asp:ListItem Text="Application ID" ></asp:ListItem>
      	 	<asp:ListItem Text="Customer Name" ></asp:ListItem>
			<asp:ListItem Text="Address" ></asp:ListItem>
			<asp:ListItem Text="Product Offering" ></asp:ListItem>
      	</asp:dropdownlist > 
  ...
  <asp:GridView runat="server" id="GrdListCustomer" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%" >
    <Columns>
		...
		<asp:templatefield HeaderText="ACTION">
			<AlternatingItemTemplate>
				<asp:HyperLink runat="server" id="lnkNewApplication" NavigateUrl="SurveyReportDEMotorZumaEntryAssetDataList.aspx" Target="_self">Entry Asset
				</asp:HyperLink>
			</AlternatingItemTemplate>
			<ItemStyle HorizontalAlign="Center" />
			<ItemTemplate>
