...
<br>
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="EDIT">
			...
			<ItemTemplate>
				<asp:ImageButton runat="server" id="BtnEdit" ImageUrl="../../images/IconEdit.gif" PostBackUrl="SurveyReportDEMotorZumaEntryAsset.aspx" />
			</ItemTemplate>
		</asp:templatefield>
	</Columns>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <asp:ImageButton ID="imbAddNewAsset" runat="server" PostBackUrl="SurveyReportDEMotorZumaEntryAsset.aspx" ImageUrl="../../Images/ButtonAddAsset.gif"></asp:ImageButton>
	  &nbsp;
	  <asp:ImageButton ID="imbCancel" runat="server" PostBackUrl="SurveyReportDEMotorZumaAssetDataList.aspx" ImageUrl="../../Images/ButtonCancel.gif"></asp:ImageButton>      
      </td>
    </tr>
    <tr> 
      <td width="20%" height="30">&nbsp;</td>
