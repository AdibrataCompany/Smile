...
<div align="center"> 
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopihijau">ZUMA NEW APPLICATION</td>
    ...
    <tr> 
      ...
      <td class="tdganjil" >
      	<asp:dropdownlist id="ddlSearchBy" runat="server" >
			<asp:ListItem Text="Zuma No" Value="0"></asp:ListItem>      	
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      <td width="10" class="tdtopihijaukiri" style="height: 20px"></td>
      <td align="center" class="tdtopihijau" style="height: 20px">CUSTOMER LISTING</td>
      <td width="10" class="tdtopihijaukanan" style="height: 20px"></td>
    </tr>
  </table>
  ...
  <asp:GridView runat="server" id="GrdListCustomer"  AllowSorting="true" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%" >
    <Columns>
 		<asp:templatefield HeaderText="ZUMA NO" SortExpression="ZumaNo">
			<AlternatingItemTemplate>
				<asp:HyperLink runat="server" id="lnkZumaNo" NavigateUrl="../../Credit/ViewZumaApplication.aspx" Target="_blank">xxxxxxxx50xxxxxxxx
				</asp:HyperLink>
			</AlternatingItemTemplate>
		...
		<asp:templatefield HeaderText="ACTION">
			<AlternatingItemTemplate>
					<asp:HyperLink runat="server" id="lnkNewApplication" NavigateUrl="SurveyReportDEMotorZumaApplicationData.aspx" Target="_self">Entry Application
				</asp:HyperLink>

			</AlternatingItemTemplate>
			<ItemTemplate>
					<asp:HyperLink runat="server" id="lnkNewApplication" NavigateUrl="SurveyReportDEMotorZumaApplicationData.aspx" Target="_self">Entry Application				</asp:HyperLink>
