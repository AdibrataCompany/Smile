...
<body>
<form runat="Server" id="frmSurveyReportDEMotorOtherDataList">
<div align="center"> 
  ...
  <asp:GridView runat="server" id="GrdListCustomer" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%" >
    <Columns>
		...
		<asp:templatefield HeaderText="ACTION">
			<ItemStyle HorizontalAlign="Center" />
			<ItemTemplate>
				<asp:HyperLink runat="server" id="lnkNewApplication" NavigateUrl="SurveyReportDEMotorOtherData.aspx" Target="_self">Entry Other Data
				</asp:HyperLink>
			</ItemTemplate>
		</asp:templatefield>
	</Columns>
