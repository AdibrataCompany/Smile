...
<br>
    ...
    <tr class="trtopikuning"> 
 	...
 	<tr> 
      <td width="20%" class="tdgenap">&nbsp;Purposed Unit</td>
  ...
  <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tablegrid">
    <tr> 
      <td class="tdjudulhijau">MEMBERS OF GROUP</td>
    </tr>
  </table>
...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
 ...
 <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <asp:ImageButton id="imbAddBankStatment" imageurl="../../Images/ButtonAdd.gif" runat="server"></asp:ImageButton>
     <asp:HyperLink runat="server" id="HLinkCopyBankStatement" ImageUrl="../../images/ButtonCopy.gif" NavigateUrl="../../Credit/FinancialDataAgreementList.aspx" Target="_search"></asp:HyperLink>
      </td>
    </tr>
  </table>
  <table align="center" width="95%">
   ...
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right"><asp:ImageButton id="imbSearch" imageurl="../../Images/ButtonSave.gif" runat="server" PostBackUrl="MarketingMemoLSApplicationData.aspx"></asp:ImageButton>
		<asp:ImageButton id="imbCancel" postbackurl="MarketingMemoLS.aspx" imageurl="../../Images/ButtonCancel.gif" runat="server"></asp:ImageButton>
      </td>
    </tr>
  </table>
</div>
