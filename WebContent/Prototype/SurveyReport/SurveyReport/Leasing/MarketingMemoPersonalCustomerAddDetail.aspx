  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
     ...
     <tr> 
      ...
      <td class="tdganjil"><asp:label id="lblProduct" runat="server">LS</asp:label></td>
    </tr>
	<table width="95%">
	 <tr> 
...
<table width="95%">
   <tr> 
	...
	<asp:Hyperlink  ImageUrl="../../Images/IconDetail.gif" ID="ucIndustryType" runat="server" NavigateUrl="../../Lookup/IndustryTypeLookup.aspx" Target="_blank"></asp:Hyperlink><font color="red">*)</font></td>
    </tr>
    <tr> 
  ...
  <table width="95%" align="center">
   ...
   <table width="95%" align="center">
    ...
    <tr>
     ...
     <tr> 
      <td class="tdgenap">Industry Type</td>
      <td class="tdganjil" colspan="3"><asp:textbox id="txtOtherIndustryType" runat="server" cssclass="inptype" width="10%"></asp:textbox>
	<asp:Hyperlink  ImageUrl="../../Images/IconDetail.gif" ID="ucOtherIndustryType" runat="server" NavigateUrl="../../Lookup/IndustryTypeLookup.aspx" Target="_blank"></asp:Hyperlink><font color="red">*)</font></td>
    </tr>
    <tr>
   ...
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="30%" align="right"><asp:ImageButton id="imbSavePersonalCustomerSurveyReport" imageurl="../../Images/ButtonSave.gif" runat="server" PostBackUrl="MarketingMemoLSApplicationDataPersonalCustomer.aspx"></asp:ImageButton>
