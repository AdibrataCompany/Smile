...
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="ACTION">
			<AlternatingItemTemplate>
				<asp:ImageButton runat="server" id="BtnEdit" ImageUrl="../images/IconEdit.gif" PostBackUrl="../CustomerMaintenance/CompanyCustomerMaintenance.aspx" />
			</AlternatingItemTemplate>
			<ItemTemplate>
				<asp:ImageButton runat="server" id="BtnEdit" ImageUrl="../images/IconEdit.gif" PostBackUrl="../CustomerMaintenance/PersonalCustomerMaintenance.aspx" />
			</ItemTemplate>
			<ItemStyle HorizontalAlign="Center" />
		</asp:templatefield>
	</Columns>
  ...
  <table width="95%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td width="50%" height="30">&nbsp;</td>
      <td width="50%" align="right"><a href="PersonalCustomerAdd.aspx"><img src="../Images/ButtonAddPersonal.gif" width="100" height="20" border="0"></a> 
        <a href="CompanyCustomerAdd.aspx"><img src="../Images/ButtonAddCompany.gif" width="100" height="20" border="0"></a> 
      </td>
    </tr>
  </table>
...
<div align="center">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      <td width="10" height="20" class="tdtopihijaukiri">&nbsp;</td>
      <td align="center" class="tdtopihijau">CUSTOMER FROM PROSPECT LISTING</td>
      <td width="10" class="tdtopihijaukanan">&nbsp;</td>
    </tr>
  </table>
    <asp:GridView runat="server" id="GrdListProspect" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%" >
    <Columns>
		<asp:templatefield HeaderText="NAME">
			<AlternatingItemTemplate>
		...
		<asp:templatefield HeaderText="GET THIS Data">
			<AlternatingItemTemplate>
				<asp:ImageButton runat="server" id="BtnEdit" ImageUrl="../images/IconEdit.gif" PostBackUrl="../CustomerMaintenance/CustomerPersonalMaintenance.aspx" />
			</AlternatingItemTemplate>
			<ItemTemplate>
				<asp:ImageButton runat="server" id="BtnEdit" ImageUrl="../images/IconEdit.gif" PostBackUrl="../CustomerMaintenance/CustomerCompanyMaintenance.aspx" />
			</ItemTemplate>
			<ItemStyle HorizontalAlign="Center" />
		</asp:templatefield>
	</Columns>
