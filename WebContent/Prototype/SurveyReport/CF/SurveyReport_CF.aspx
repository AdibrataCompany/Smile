...
<div align="center"> 
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      ...
      <td colspan="3" class="tdganjil"><asp:textbox id="txtgAddress" runat="server" cssclass="inptype" width="50%"></asp:textbox></td>
    </tr>
    <tr> 
...
<table width="95%">
   <tr> 
    ...
    <tr> 
      ...
      <td class="tdganjil"  colspan="3"><asp:textbox id="txtJobDataBusinessAddress" runat="server" cssclass="inptype" width="10%"></asp:textbox></td>
    </tr>
     <tr> 
      <td class="tdgenap" width="20%">RT/RW</td>
 ...
 / <font face="Tahoma, Verdana" size="2"> 
    ...
    <tr> 
      ...
      <td class="tdganjil" colspan="3"><font face="Tahoma, Verdana" size="2"> 
			<asp:textbox id="txtEmployeeSinceYear" runat="server" cssclass="inptype" width="5%"></asp:textbox>
        </font></td>
    </tr>
    <tr> 
    ...
    <table width="95%" align="center">
    <tr> 
      <td width="20%" class="tdjudulhijau" colspan="2">OTHER BUSINESS<font color="red"> </font> 
      </td>
