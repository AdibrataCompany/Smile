  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
   ...
   <tr>
    ...
    <td class="tdgenap">Copy From Asset</td>
      <td class="tdganjil"><asp:dropdownlist id="ddlCopyFromAsset" runat="server" cssclass="inptype" width="50">
...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="95%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td width="50%" height="30">&nbsp;</td>
      <td width="50%" align="right" class="tdganjil">
      <asp:ImageButton id="imbNextMarketingMemo" imageurl="../../Images/ButtonNext.gif" postbackurl="SurveyReport_CF_InsuranceDataSummary.aspx" runat="server"></asp:ImageButton>
        <asp:ImageButton ID="imbCancelEntryInsurance" runat="server" PostBackUrl="SurveyReport_CF_InsuranceDataList.aspx" ImageUrl="../../Images/ButtonCancel.gif"></asp:ImageButton>
