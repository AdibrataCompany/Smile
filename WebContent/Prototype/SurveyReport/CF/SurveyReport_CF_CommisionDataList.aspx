...
<div align="center"> 
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopihijau">SURVEY REPORT - COMMISION DATA</td>
  ...
  <asp:GridView runat="server" id="GrdListCustomer" AllowSorting="true" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%" >
    ...
    <asp:templatefield HeaderText="APPLICATION ID" SortExpression="ApplicationID">
		...
		<asp:templatefield HeaderText="ACTION">
			<AlternatingItemTemplate>
					<asp:HyperLink runat="server" id="lnkNewApplication" NavigateUrl="SurveyReport_CF_CommisionProcessCalculate.aspx" Target="_self">Entry Commision
				</asp:HyperLink>

			</AlternatingItemTemplate>
			<ItemTemplate>
					<asp:HyperLink runat="server" id="lnkNewApplication" NavigateUrl="SurveyReport_CF_CommisionProcessCalculate.aspx" Target="_self">Entry Commision				</asp:HyperLink>
