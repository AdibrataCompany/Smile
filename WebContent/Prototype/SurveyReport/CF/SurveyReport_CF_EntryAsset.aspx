...
<div align="center"> 
  ...
  <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tablegrid">
    <tr> 
      <td colspan="2" class="tdjudulhijau" style="width: 295px">SUPPLIER <font color="red">*)</font> 
      </td>
      <td class="tdjudulhijau">NOTES<font color="red">*)</font></td>
      <td class="tdjudulhijau">OTR PRICE <font color="red">*)</font></td>
  ...
  <table width="95%">
     ...
     <tr> 
      ...
      <td class="tdganjil"><asp:textbox ID="txtBasicPriceList" CssClass="inptype" runat="server"></asp:textbox> 
      </td>
...
<table width="95%">
 <tr> 
      ...
      <td colspan="3" class="tdganjil"><font face="Tahoma, Verdana" size="2"> 
       <asp:TextBox ID="txtSupplier" runat="server" CssClass="inptype"></asp:TextBox>
        </font></td>
    </tr>
    <tr> 
      <td valign="top" class="tdgenap" style="width: 28%">Price Estimation</td>
      <td colspan="3" class="tdganjil"><font face="Tahoma, Verdana" size="2"> 
       <asp:TextBox ID="txtSupplierPriceEstimation" runat="server" CssClass="inptype"></asp:TextBox>
        </font></td>
    </tr>
	<tr> 
      <td colspan="4" class="tdganjil" align="right"><font face="Tahoma, Verdana" size="2"> 
      <asp:ImageButton ID="imbAddPriceEstimation" runat="server" ImageUrl="../../Images/ButtonAdd.gif"></asp:ImageButton>
  ...
  <tr> 
      ...
      <td colspan="3" class="tdganjil">
      <asp:TextBox ID="txtSupplierName" runat="server" CssClass="inptype"></asp:TextBox ></td>
    </tr>
  ...
  <table width="95%">
    ...
    <tr> 
      ...
      <td width="25%" class="tdganjil"><input type="radio" name="radiobutton1" value="radiobutton" checked="true">
        New 
    ...
    <tr> 
      ...
      <td class="tdganjil"><font face="Tahoma, Verdana" size="2"> 
        <input name="textfield323" type="text" class="inptype" size="15">
        </font></td>
      <td class="tdgenap">Usage</td>
		<td class="tdganjil"><select name="select10">
		<option>Select one</option>
		<option selected="">Non Commercial</option>
		<option>Commercial</option>
		</select> <font color="red">*)</font></td>
    </tr>
    <tr> 
      <td class="tdgenap" style="width: 28%">Manufacturing Year</td>
      <td colspan="3" class="tdganjil"><input name="textfield325" type="text" class="inptype" value="0" size="15"> 
      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td class="tdganjil" colspan=3> <input name="textfield3222" type="text" class="inptype" size="15"> 
        <a href="javascript:;" onClick="MM_openBrWindow('../Lookup/CustomerLookup.htm','Customer','scrollbars=yes,width=900,height=500,left=0,top=0')"><img src="../../Images/IconDetail.gif" width="15" height="15" align="absmiddle" border="0"></a> 
      </td>
    </tr>
    <tr> 
...
<input type="checkbox" name="checkbox2" value="checkbox">
 ...
 <br>
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr valign="bottom"> 
      <td align="right">  
<asp:CheckBox ID="chkContinue" runat="server" Text="Continue entry for this application"></asp:CheckBox>
      <asp:ImageButton runat="server" ImageUrl="../../Images/ButtonSave.gif" PostBackUrl="SurveyReport_CF_InsuranceAssetList.aspx"  ID="imbEntryAssetSave"></asp:ImageButton>
      <asp:ImageButton runat="Server" ImageUrl="../../Images/ButtonCancel.gif" PostBackUrl="SurveyReport_CF_AssetDataList.aspx" ID="imbEntryAssetCancel"></asp:ImageButton>
