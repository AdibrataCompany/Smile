...
<div align="center"> 
  ...
  <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tablegrid">
   <tr>
	...
	<tr> 
      ...
      <td class="tdganjil" width="80%">Main Dealer / Showroom / Authorized Dealer / OtU</td>
    </tr>
  ...
  <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tablegrid">
    ...
    <tr>
      ...
      <td class="tdganjil" width="30%" style="height: 26px"><asp:TextBox ID="txtOTR" runat="server" CssClass="inptype"></asp:TextBox>
      <font color="red">*)</font>&nbsp;<font color="red">Zuma.OTRPrice</font>
      </td>
       <td class="tdgenap" width="20%">Price List</td>
	  <td class="tdganjil" width="20%">999.999,99</td>	
    </tr>
    ...
    <tr> 
      ...
      <asp:RadioButtonlist runat="server" id="RdBtnListUnitDuration0" RepeatDirection="Horizontal" AutoPostBack="true" Enabled="false">
			<asp:ListItem Text="Standard" Value="N" Selected="True"></asp:ListItem>
			<asp:ListItem Text="Less Standard" Value="U"></asp:ListItem>
    ...
    <tr> 
      ...
      <td class="tdgenap" width="20%">Unit Duration</td>
		<td class="tdganjil" width="30%">
      <asp:RadioButtonlist runat="server" id="RdBtnListUnitDuration" RepeatDirection="Horizontal" AutoPostBack="true" Enabled="false">
			<asp:ListItem Text="< 1 Year" Value="N" Selected="True"></asp:ListItem>
			<asp:ListItem Text="1 - 3 Years" Value="U"></asp:ListItem>
    ...
    <tr> 
      ...
      <td class="tdganjil" width="30%">
			 <asp:TextBox ID="txtFundingAmount0" runat="server" CssClass="inptype" Width="50"></asp:TextBox>  
	  &nbsp;<font color="red">Zuma.ManufacturingYear</font></td>
      <td class="tdgenap" width="20%">Manufacturing Country</td>
		<td class="tdganjil" width="30%">
		xxxxx99xxxxx</tr>
    ...
    <tr>
      ...
      <td class="tdganjil" width="30%" colspan="3" >
        <input name="textfield32326323" type="text" class="inptype" size="15">
	  </td>
    </tr>
	<tr>
      <td class="tdgenap"width="20%">License Plate [Attribute 2]</td>
      <td class="tdganjil" width="30%" colspan="3" >
        <input name="textfield32322" type="text" class="inptype" size="15">&nbsp;<font color="red">Zuma.LicensePlate</font>
      </td>
    </tr>
    

    <tr> 
      <td class="tdgenap" width="20%">Funding Amount</td>
      <td class="tdganjil" width="30%">
			 <asp:TextBox ID="txtFundingAmount" runat="server" CssClass="inptype"></asp:TextBox>  
      <font color="red">*)</font></td>
      <td class="tdgenap" width="20%">Cylinder</td>
		<td class="tdganjil" width="30%">
		9999</tr>
    

    <tr> 
      <td class="tdgenap" width="20%">Admin Fee</td>
      <td class="tdganjil" width="30%" colspan="3" >
      
     <asp:TextBox ID="txtAdminFee" runat="server" CssClass="inptype"></asp:TextBox>  
     <asp:ImageButton id="imbCalcAdmin" imageurl="../../Images/ButtonCalculate.gif" runat="server"></asp:ImageButton>     </td>
    </tr>
    <tr> 
      <td class="tdgenap" width="20%">Chassis No [Serial No 1]</td>
      <td class="tdganjil" width="30%" colspan="3" >
        <input name="textfield3232" type="text" class="inptype" size="15">&nbsp;<font color="red">Zuma.SerialNo1</font>
	  </td>
    </tr>
    <tr> 
      <td class="tdgenap" width="20%">Engine No [Serial No 2]</td>
      <td class="tdganjil" width="30%" colspan="3" >
        <input name="textfield3232" type="text" class="inptype" size="15">&nbsp;<font color="red">Zuma.SerialNo2</font>
	  </td>
    </tr>
    ...
    <tr> 
      ...
      <td class="tdganjil" width="80%"> 		  
  		  <asp:DropDownList ID="ddlInsuranceCo0" runat="server" Width="126px" Height="17px">
             <asp:ListItem Text="Select One" Value="0"></asp:ListItem>
           	 <asp:ListItem Text="Non Group" ></asp:ListItem>
           	 <asp:ListItem Text="Group" ></asp:ListItem>
      	  </asp:DropDownList>
      </td>
    ...
    <tr> 
      ...
      <td class="tdganjil" colspan=3> 
		<input name="textfield3222" type="text" class="inptype" size="15" style="width: 172px">&nbsp; 
		      <asp:HyperLink ID="hypAssetRegisCustomer" runat="server" ImageUrl="../../Images/IconDetail.gif" NavigateUrl="../../Lookup/CustomerLookup.htm" Target="_blank"></asp:HyperLink>
    ...
    <tr> 
      <td colspan="4" class="tdjudulhijau" style="height: 20px">ASSET REGISTRATION INFORMATION
      </td>
    </tr>
     <tr> 
      <td class="tdgenap" style="width: 28%">Relationship with Customer</td>
    ...
    <tr> 
      <td class="tdgenap" style="width: 28%">Asset Notes</td>
      <td class="tdganjil" colspan=3> 
		<asp:TextBox ID="txtAssetNotes" runat="server" Height="75" Width="300" CssClass="inptype"></asp:TextBox>&nbsp; 
...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="30%" align="right"><a href="../../Credit/ApplicationMaintenance.htm" ><img src="../../Images/ButtonSave.gif" border="0" /></a>		
      <asp:ImageButton id="imbCancelSurveyReportDEMotor" postbackurl="SurveyReportDEMotorZumaAssetDataList.aspx" imageurl="../../Images/ButtonCancel.gif" runat="server"></asp:ImageButton>
      </td>
    </tr>
  </table>
