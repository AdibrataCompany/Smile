...
<body>
<form runat="Server" id="frmSurveyReportDEMotorCommisionDataList">
<div align="center"> 
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      <td width="10" height="20" class="tdtopihijaukiri">&nbsp;</td>
      <td align="center" class="tdtopihijau">SURVEY REPORT DE MOTOR - COMMISION DATA</td>
  ...
  <asp:GridView runat="server" id="GrdListCustomer" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%" >
    <Columns>
		...
		<asp:templatefield HeaderText="ACTION">
			<AlternatingItemTemplate>
				<asp:HyperLink runat="server" id="lnkNewApplication" NavigateUrl="SurveyReportDEMotorCommissionProcessCalculate.aspx" Target="_self">Entry Commision
				</asp:HyperLink>
			</AlternatingItemTemplate>
			<ItemStyle HorizontalAlign="Center" />
			<ItemTemplate>
