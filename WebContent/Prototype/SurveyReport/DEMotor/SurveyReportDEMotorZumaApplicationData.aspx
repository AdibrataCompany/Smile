...
<div align="center"> 
   ...
   <td class="tdgenap">Surveyor</td>
    ...
    <tr> 
      ...
      <td class="tdganjil">
   	...
   	<tr> 
      <td class="tdgenap" style="width: 20%">Coverage Area</td>
      <td class="tdganjil">
			<asp:dropdownlist id="ddlCoverageArea" runat="server" width="20%" AutoPostBack="true">
			<asp:ListItem Text="0 - 10 KM" Value="1" Selected="True"></asp:ListItem>
			<asp:ListItem Text="11 - 99 KM" Value="2"></asp:ListItem>
			<asp:ListItem Text="> 99 KM" Value="2"></asp:ListItem>
			</asp:dropdownlist>
		</td>
    </tr>
 ...
 <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      <td width="10" height="20" class="tdtopihijaukiri">&nbsp;</td>
      <td align="center" class="tdtopihijau">CROSS DEFAULT</td>
      <td width="10" class="tdtopihijaukanan">&nbsp;</td>
    </tr>
  </table>
	<asp:GridView runat="server" id="gridDC"  AllowSorting="true" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%" >
    <Columns>
    	<asp:boundfield DataField="valstring2" HeaderText="NO" SortExpression="valstring2">
			<ItemStyle HorizontalAlign="Center" />
		</asp:boundfield>	
		<asp:boundfield DataField="valstring20" HeaderText="AGREEMENT" SortExpression="valstring20">
			<ItemStyle HorizontalAlign="Center" />
		</asp:boundfield>
		...
		<asp:boundfield DataField="valstring2" HeaderText="DEFAULT STATUS" SortExpression="valstring2">
			<ItemStyle HorizontalAlign="Center" />
		</asp:boundfield>
		<asp:boundfield DataField="valstring20" HeaderText="APPLICATION ID" SortExpression="valstring20">
			<ItemStyle HorizontalAlign="Center" />
		</asp:boundfield>
		<asp:boundfield DataField="valstring2" HeaderText="CONTRACT STATUS" SortExpression="valstring2">
			<ItemStyle HorizontalAlign="Center" />
		</asp:boundfield>
		<asp:templatefield HeaderText="DELETE">
			<AlternatingItemTemplate>
				<asp:ImageButton ID="imbCDDelete" runat="server" ImageUrl="../../Images/IconDelete.jpg"></asp:ImageButton>
			</AlternatingItemTemplate>
			<AlternatingItemTemplate>
				<asp:ImageButton ID="imbCDDelete1" runat="server" ImageUrl="../../Images/IconDelete.gif"></asp:ImageButton>
			</AlternatingItemTemplate>
			<ItemStyle HorizontalAlign="CENTER" />
		</asp:templatefield>
	</Columns>
