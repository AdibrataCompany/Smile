  ...
  <asp:GridView runat="server" id="GrdCommissionData" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%" >
    <Columns>
		...
		<asp:templatefield HeaderText="INTEREST RATE UPPING (%)">
			<ItemStyle HorizontalAlign="Right" />
			<ItemTemplate>
				<asp:TextBox runat="server" id="txtInterestRateUpping" Text="99.99" CssClass="inptype" Width="100%">
				</asp:TextBox>
			</ItemTemplate>
		</asp:templatefield>
		...
		<asp:templatefield HeaderText="OTHER (%)">
			<ItemStyle HorizontalAlign="Right" />
			<ItemTemplate>
				<asp:TextBox runat="server" id="txtOther" Text="99.99" CssClass="inptype" Width="100%">
				</asp:TextBox>
			</ItemTemplate>
		</asp:templatefield>
		...
		<asp:templatefield HeaderText="BANK ACCOUNT">
			<AlternatingItemTemplate>
				<asp:DropDownList runat="server" id="ddlBankAccount">
					<asp:ListItem Text="PT ABC-JKT-999.999.9999-DR. ABC" Value="JKT">
					</asp:ListItem>
					<asp:ListItem Text="PT ABC-BDG-999.999.9999-DR. ABC" Value="BDG">
					</asp:ListItem>
				</asp:DropDownList>
			</AlternatingItemTemplate>
			<ItemStyle HorizontalAlign="Right" />
...
<asp:XmlDataSource runat="server" ID="XmlDataSource1" DataFile="../../DataType.xml">
  ...
  <table width="95%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <asp:ImageButton id="imbCalculateEntryCommission" imageurl="../../Images/ButtonCalculate.gif" postbackurl="SurveyReportDEMotorCommissionProcessCalculate2.aspx" runat="server"></asp:ImageButton>
        <asp:ImageButton ID="imbCancelEntryCommission" runat="server" PostBackUrl="SurveyReportDEMotorCommissionDataList.aspx" ImageUrl="../../Images/ButtonCancel.gif"></asp:ImageButton>
