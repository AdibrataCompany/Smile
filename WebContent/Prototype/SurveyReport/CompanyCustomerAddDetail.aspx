...
<BR>
   ...
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="50%" align="right"><font color="red">*) if leasing go to marketing memo, if de motor the go to survey report de motor, else go to survey report cf</font>
<asp:ImageButton id="imbSavePersonalCustomerSurveyReport" imageurl="../Images/ButtonSave.gif" postbackurl="Leasing/MarketingMemoLSApplicationData.aspx" runat="server"></asp:ImageButton>
