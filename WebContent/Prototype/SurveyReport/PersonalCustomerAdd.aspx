  ...
  <td width="20%" class="tdgenap">Product</td>
   ...
   <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right"><asp:ImageButton id="imbSavePersonalCustomerSurveyReport" imageurl="../Images/ButtonSave.gif" postbackurl="CustomerDataDuplicateChecking.aspx" runat="server"></asp:ImageButton>
