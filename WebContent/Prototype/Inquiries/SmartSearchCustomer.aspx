...
<table width="95%" border="1" cellspacing="0" cellpadding="0" class="tablegrid">
	<tr class="tdjudulungu" height="20px" align="center">
		...
		<td><font color="red">Customer</font></td>
...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopiungu">SMART SEARCH CUSTOMER</td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      <td width="10" height="20" class="tdtopiungukiri">&nbsp;</td>
      <td align="center" class="tdtopiungu">CUSTOMER LISTING</td>
  ...
  <asp:GridView runat="server" id="grdCustomer" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%">
	<Columns>
		<asp:boundfield DataField="valstring20" HeaderText="ID" SortExpression="valstring20">
		</asp:boundfield>	
		...
		<asp:boundfield DataField="valstring1" HeaderText="TYPE" SortExpression="valstring1">
