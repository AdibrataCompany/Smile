...
<body>
<form id="FrmProductOfferingSupplierAdd" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		<a href="../AssetMnt/AssetMasterListing.htm">
		<asp:ImageButton runat="server" id="BtnSearch" ImageUrl="../../images/ButtonSearch.gif" PostBackUrl="ProductOfferingSupplierAdd.aspx" /></a>&nbsp; 
        <asp:ImageButton runat="server" id="BtnReset" ImageUrl="../../images/ButtonReset.gif" PostBackUrl="ProductOfferingSupplierAdd.aspx" /> 
      </td>
    </tr>
  </table>
  <br />
	...
	<Columns>
		<asp:templatefield HeaderText="SELECT">
			<AlternatingItemTemplate>
				<asp:CheckBox runat="server" id="CbSelectSupplierLookUp" />
			</AlternatingItemTemplate>
			<ItemTemplate>
				<asp:CheckBox runat="server" id="CbSelectSupplierLookUp" />
			</ItemTemplate>
