...
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopihijau">PRODUCT - ADD</td>
      ...
      <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
        ...
        <tr> 
          ...
          <td class="style2" colspan="2"> <font color="red">
			<asp:TextBox runat="server" id="txtProductId" CssClass="inptype"></asp:TextBox>
			*)</font> </td>
        </tr>
        <tr> 
		...
		<tr>
          ...
          <td class="style2" colspan="2"> 
			<asp:DropDownList runat="server" id="CmbVehicleType" CssClass="inptype">
				<asp:ListItem Value="P">Public (MPU)</asp:ListItem>
				<asp:ListItem Selected="True" Value="NP">Non Public (Non MPU)
				</asp:ListItem>
			</asp:DropDownList>
			</td>
        	</tr>
...
&nbsp;days
		...
		<tr>
          ...
          <td class="style2" colspan="2">
			<asp:RadioButtonList runat="server" id="rdoNotaryFeeCalcType0" RepeatDirection="Horizontal">
				<asp:ListItem Value="A" Selected="True">Amount</asp:ListItem>
				<asp:ListItem Value="P">Percentage</asp:ListItem>
			</asp:RadioButtonList></td>
        </tr>
