...
<body>
<form id="FrmProductOfferingAssetAdd2" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr>
      <td class="style3" style="width: 219px">Asset Type</td>
      <td class="style2">
<asp:DropDownList runat="server" id="ddlAssetType" CssClass="inptype">
	<asp:ListItem Selected="true">AUTOMOTIVE</asp:ListItem>
	<asp:ListItem>HEAVY EQUIPMENT</asp:ListItem>
</asp:DropDownList>
&nbsp;
		</td>
    	</tr>
		<tr>
      <td class="style3" style="width: 219px">Asset Category</td>
      <td class="style2">
<asp:DropDownList runat="server" id="CmbSearchAssetCategory" CssClass="inptype">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		<asp:ImageButton runat="server" id="BtnSearch" ImageUrl="../../images/ButtonSearch.gif" PostBackUrl="ProductOfferingAssetAdd.aspx" />&nbsp; 
        <asp:ImageButton runat="server" id="BtnReset" ImageUrl="../../images/ButtonReset.gif" PostBackUrl="ProductOfferingAssetAdd.aspx" /> 
      </td>
    </tr>
  </table>
  <br />
	...
	<Columns>
		<asp:templatefield HeaderText="SELECT">
			<AlternatingItemTemplate>
				<asp:CheckBox runat="server" id="CbSelectAssetLookUp" />
			</AlternatingItemTemplate>
			<ItemTemplate>
				<asp:CheckBox runat="server" id="CbSelectAssetLookUp" />
			</ItemTemplate>
...
&nbsp;&nbsp; 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="50%" height="30">&nbsp;</td>
      <td width="50%" align="right">
		<asp:ImageButton runat="server" id="BtnSave" ImageUrl="../../images/ButtonSelect.gif" Height="20px" PostBackUrl ="javascript:window.close();" />&nbsp;&nbsp;
		<asp:ImageButton runat="server" id="BtnCancel" ImageUrl="../../images/ButtonExit.gif" PostBackUrl ="javascript:window.close();" /></td>
    </tr>
  </table>
    				<br />
				</div>
