...
<div align="center">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopihijau">PRODUCT OFFERING DETAIL</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
      ...
      <td class="style1" colspan="3"><a href="ProductBranchView.aspx">
		CFMOHND001</a></td>
    </tr>
    <tr>
      <td width="25%" class="style2">Product Offering ID</td>
      <td class="style1" colspan="3"><a href="ProductOfferingView.aspx">
	...
	<tr>
      ...
      <td class="style2">
			Customer Rating</td>
      <td class="style1">
		<asp:DropDownList runat="server" id="ddlCustRating0" Width="103px" CssClass="inptype">
				<asp:ListItem Selected="True">All</asp:ListItem>
	...
	<tr>
      ...
      <td class="style1">
			<asp:DropDownList runat="server" id="ddlAssetGroup0" Width="103px" CssClass="inptype">
				<asp:ListItem Selected="True">All</asp:ListItem>
      ...
      <td class="style2">
		Year &gt;=</td>
      <td class="style1">
		<asp:TextBox runat="server" id="txtYear1" CssClass="inptype" Width="66px">
		</asp:TextBox>
		</td>
    </tr>
	<tr>
      ...
      <td class="style1" colspan="3">
		<asp:TextBox runat="server" id="txtTenorStart1" CssClass="inptype" Width="36px">
		</asp:TextBox>
&nbsp;To
		<asp:TextBox runat="server" id="txtTenorEnd1" CssClass="inptype" Width="36px">
		</asp:TextBox>
		</td>
      </tr>
    </table>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr>
      <td width="50%" class="style2">Copy Data From Product Branch Detail</td>
      <td class="style2">
      ...
      <asp:GridView runat="server" id="GrdViewProductBranchDetailListing" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%">
		<Columns>
			...
			<asp:templatefield HeaderText="EDIT">
				<AlternatingItemTemplate>
					<asp:ImageButton runat="server" id="BtnIcoEdit" ImageUrl="../../images/IconEdit.gif" PostBackUrl="ProductOfferingDetailEdit.aspx" />
				</AlternatingItemTemplate>
				<ItemTemplate>
					<asp:ImageButton runat="server" id="BtnIcoEdit" ImageUrl="../../images/IconEdit.gif" PostBackUrl="ProductOfferingDetailEdit.aspx" />
				</ItemTemplate>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="50%" height="30" class="style3">
		<asp:ImageButton runat="server" id="BtnBack" ImageUrl="../../images/ButtonBack.gif" PostBackUrl="ProductOffering.aspx" /></td>
      <td width="50%" align="right">
		&nbsp;</td>
    </tr>
  </table>
