...
<div align="center">
  ...
  <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tablegrid">
	...
	<tr>
          ...
          <td class="style3" colspan="2">Non Group</td>
        </tr>
	<tr>
          <td class="style1">Product Type</td>
          <td class="style3" colspan="2">KCM</td>
        </tr>
	<tr>
          <td class="style1">Asset Type</td>
          <td class="style3" colspan="2">AUTOMOTIVE</td>
        </tr>
	<tr>
          <td class="style1">Asset Category</td>
          <td class="style3" colspan="2">Truck</td>
        </tr>
	<tr>
          <td class="style1">Asset Usage</td>
          <td class="style3" colspan="2">Commercial</td>
        </tr>
	<tr>
	...
	<tr>
          ...
          <td class="style3" colspan="2">Yes</td>
        </tr>
	<tr>
