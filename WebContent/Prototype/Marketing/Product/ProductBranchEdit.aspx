...
<div align="center">
  ...
  <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tablegrid">
	...
	<tr>
          ...
          <td class="style3" colspan="3">KCM</td>
        </tr>
	<tr>
          <td class="style1">Asset Type</td>
          <td class="style3" colspan="3">AUTOMOTIVE</td>
        </tr>
	<tr>
          <td class="style1">Asset Category</td>
          <td class="style3" colspan="3">Truck</td>
        </tr>
	<tr>
          <td class="style1">Asset Usage</td>
          <td class="style3" colspan="3">Commercial</td>
        </tr>
	<tr>
	...
	<tr>
          ...
          <td class="style3" colspan="3">Yes</td>
        </tr>
	<tr>
