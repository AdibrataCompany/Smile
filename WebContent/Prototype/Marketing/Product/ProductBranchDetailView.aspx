...
<div align="center">
  ...
  <div align="center">
    <div align="center"> 
      <asp:GridView runat="server" id="GrdViewProducPerTenortListing" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%">
		<Columns>
			...
			<asp:templatefield HeaderText="DETAIL">
				<AlternatingItemTemplate>
					<asp:HyperLink runat="server" id="lnkDetail" NavigateUrl="ProductBranchDetailView2.aspx" Text="Detail" />
				</AlternatingItemTemplate>
				<ItemTemplate>
					<asp:HyperLink runat="server" id="lnkDetail" NavigateUrl="ProductBranchDetailView2.aspx" Text="Detail" />
				</ItemTemplate>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="50%" height="30" class="style3">
		<asp:ImageButton runat="server" id="BtnBack" ImageUrl="../../images/ButtonBack.gif" PostBackUrl="ProductBranchView.aspx" /></td>
