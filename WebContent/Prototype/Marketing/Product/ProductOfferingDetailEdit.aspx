...
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopihijau">PRODUCT OFFERING DETAIL - EDIT</td>
  ...
  <div align="center">
    <div align="center">
      <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
        ...
        <tr> 
          <td class="style1">Product Offering ID</td>
          <td class="style2" colspan="2">
		<a href="ProductOfferingView.aspx" target="_blank">xxxxx20xxxxx</a></td>
        </tr>
        <tr> 
		...
		Branch</td>
          <td width="30%"> 
		Offering (Spread from Branch)</td>
        </tr>
        <tr> 
		...
		10 %</td>
          <td class="style2"> 
		+ 
		<asp:TextBox runat="server" id="txtMinDPCategA" CssClass="inptype" Height="16px" Width="60px">2
		</asp:TextBox>
			&nbsp;%</td>
        </tr>
        <tr> 
		...
		15 %</td>
          <td class="style2"> 
		+ 
		<asp:TextBox runat="server" id="txtMinDPCategB" CssClass="inptype" Height="16px" Width="60px">5
		</asp:TextBox>
			&nbsp;%</td>
        </tr>
        <tr>
		...
		2,500,000.00</td>
          <td class="style2"> 
		+ 
		<asp:TextBox runat="server" id="txtMinIntIncWarn" CssClass="inptype" Height="16px">250,000.00
		</asp:TextBox>
			</td>
        	</tr>
        <tr> 
		...
		1,500,000.00</td>
          <td class="style2"> 
		+ 
		<asp:TextBox runat="server" id="txtMinIntIncRej" CssClass="inptype" Height="16px">250,000.00
		</asp:TextBox>
			</td>
        </tr>
        <tr> 
		...
		300,500,000.00</td>
          <td class="style2"> 
		+ 
		<asp:TextBox runat="server" id="txtMaxNTF" CssClass="inptype" Height="16px">250,000.00
		</asp:TextBox>
			</td>
        </tr>
        <tr> 
          ...
          <td class="style2"> 
				+ 
				<asp:TextBox runat="server" id="txtAdminFee" CssClass="inptype">25,000.00</asp:TextBox>
			</td>
        </tr>
        <tr> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		<asp:ImageButton runat="server" id="BtnSave" ImageUrl="../../images/ButtonSave.gif" PostBackUrl="ProductOfferingDetail.aspx" Height="20px" />&nbsp;
		<asp:ImageButton runat="server" id="BtnCancel" ImageUrl="../../images/ButtonCancel.gif" PostBackUrl="ProductOfferingDetail.aspx" /></td>
    </tr>
  </table>
    </div>
