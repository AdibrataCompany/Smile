...
<body>
<form id="FrmProductBudgetAdd" runat="server">
<div align="center">
  <div align="center">
    <div align="center"> 
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      ...
      <td width="50%" align="right">
        <asp:HyperLink runat="server" id="HLinkCopy" ImageUrl="../../images/ButtonCopy.gif" NavigateUrl="../../lookup/ProductBudgetLookup.aspx" Target="_search"></asp:HyperLink>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="50%" height="30" class="style3">
		&nbsp;</td>
      <td width="50%" align="right">
		<asp:ImageButton runat="server" id="BtnSave" ImageUrl="../../images/ButtonSave.gif" PostBackUrl="ProductBudgetListing.aspx" />&nbsp;
		<asp:ImageButton runat="server" id="BtnCancel" ImageUrl="../../images/ButtonCancel.gif" PostBackUrl="ProductBudgetlisting.aspx" />&nbsp;</td>
    </tr>
  </table>
