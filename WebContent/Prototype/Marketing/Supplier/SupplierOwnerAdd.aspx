...
<body>
<form id="FrmSupplierOwnerAdd" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopihijau">SUPPLIER OWNER - ADD</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
      ...
      <td class="style3">
		<font color="red">
		<asp:TextBox runat="server" id="TbsName" Width="315px" CssClass="inptype">
		</asp:TextBox>
		&nbsp; *)</font> </td>
    </tr>
    <tr> 
      ...
      <td class="style3"> 
		<asp:TextBox runat="server" id="TbsTitle" Width="200px" CssClass="inptype">
		</asp:TextBox>
		</td>
    </tr>
    <tr> 
      ...
      <td class="style3">
		<asp:TextBox runat="server" id="TbsBirthPlace" Width="100px" CssClass="inptype">
		</asp:TextBox>
		&nbsp; /&nbsp;
		<asp:TextBox runat="server" id="TbdDate" Width="100px" CssClass="inptype">
		</asp:TextBox>
		&nbsp;
...
&nbsp;- 
    ...
    <tr> 
      ...
      <td class="style3">
		<asp:TextBox runat="server" id="TbsMobilePhone" Width="200px" CssClass="inptype"></asp:TextBox>
		</td>
    </tr>
    <tr> 
      <td class="style1" style="width: 93%">E-Mail</td>
      <td class="style3">
		<asp:TextBox runat="server" id="TbsEmail" Width="200px" CssClass="inptype"></asp:TextBox>
		</td>
    </tr>
    </table>
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
