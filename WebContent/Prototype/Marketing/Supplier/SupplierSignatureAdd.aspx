...
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopihijau">SUPPLIER SIGNATURE - ADD</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
      ...
      <td class="style3">
		<asp:TextBox runat="server" id="TbsName" Width="334px" CssClass="inptype"></asp:TextBox>
&nbsp;
    ...
    <tr> 
      ...
      <td class="style3">
        <asp:TextBox runat="server" id="TbsJobTitle" Width="200px" CssClass="inptype"></asp:TextBox>
&nbsp; <span class="style5">*)</span></td>
    </tr>
    <tr> 
      <td class="style1" style="width: 25%">Signature</td>
      <td class="style3">
        <asp:TextBox runat="server" id="TbsSignature" Width="246px" CssClass="inptype"></asp:TextBox>
		&nbsp; <span class="style5">
