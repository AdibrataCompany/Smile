    ...
    <div align="center"> 
      <asp:GridView runat="server" id="GrdViewSupplierListing" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%">
		<Columns>
			...
			<asp:boundfield DataField="valstring20" SortExpression="valstring20" HeaderText="BUSINESS NAME">
			</asp:boundfield>
			...
			<asp:templatefield HeaderText="BRANCH">
				<AlternatingItemTemplate>
					<asp:HyperLink runat="server" id="LinkBranch" NavigateUrl="SupplierBranch.aspx" Target="_self">Branch
					</asp:HyperLink>
				</AlternatingItemTemplate>
				<ItemTemplate>
					<asp:HyperLink runat="server" id="LinkBranch" NavigateUrl="SupplierBranch.aspx" Target="_self">Branch
			...
			<asp:templatefield HeaderText="OWNER">
				<AlternatingItemTemplate>
					<asp:HyperLink runat="server" id="LinkOwner" NavigateUrl="SupplierOwner.aspx" Target="_self">Owner
					</asp:HyperLink>
				</AlternatingItemTemplate>
				<ItemTemplate>
					<asp:HyperLink runat="server" id="LinkOwner" NavigateUrl="SupplierOwner.aspx" Target="_self">Owner
			...
			<asp:templatefield HeaderText="EMPLOYEE">
				<AlternatingItemTemplate>
					<asp:HyperLink runat="server" id="LinkEmployee" NavigateUrl="SupplierEmployee.aspx" Target="_self">Employee
					</asp:HyperLink>
				</AlternatingItemTemplate>
				<ItemTemplate>
					<asp:HyperLink runat="server" id="LinkEmployee" NavigateUrl="SupplierEmployee.aspx" Target="_self">Employee
			...
			<asp:templatefield HeaderText="BANK ACCOUNT">
				<AlternatingItemTemplate>
					<asp:HyperLink runat="server" id="LinkBankAccount" NavigateUrl="SupplierBankAccount.aspx" Target="_self">Bank Account
					</asp:HyperLink>
				</AlternatingItemTemplate>
				<ItemTemplate>
					<asp:HyperLink runat="server" id="LinkBankAccount" NavigateUrl="SupplierBankAccount.aspx" Target="_self">Bank Account
			...
			<asp:templatefield HeaderText="SIGNATURE">
				<AlternatingItemTemplate>
					<asp:HyperLink runat="server" id="LinkSignature" NavigateUrl="SupplierSignature.aspx" Target="_self">Signature
					</asp:HyperLink>
				</AlternatingItemTemplate>
				<ItemTemplate>
					<asp:HyperLink runat="server" id="LinkSignature" NavigateUrl="SupplierSignature.aspx" Target="_self">Signature
			...
			<asp:templatefield HeaderText="BAD STATUS">
				<AlternatingItemTemplate>
					<asp:HyperLink runat="server" id="LinkBadStatus" NavigateUrl="SupplierBadStatus.aspx" Target="_self">Bad Status
					</asp:HyperLink>
				</AlternatingItemTemplate>
				<ItemTemplate>
					<asp:HyperLink runat="server" id="LinkBadStatus" NavigateUrl="SupplierBadStatus.aspx" Target="_self">Bad Status
			...
			<asp:templatefield HeaderText="EDIT">
				<AlternatingItemTemplate>
					<asp:ImageButton runat="server" id="BtnEdit" ImageUrl="../../images/IconEdit.gif" PostBackUrl="SupplierEdit.aspx" />
				</AlternatingItemTemplate>
				<ItemTemplate>
					<asp:ImageButton runat="server" id="BtnEdit" ImageUrl="../../images/IconEdit.gif" PostBackUrl="SupplierEdit.aspx" />
				</ItemTemplate>
...
&nbsp;&nbsp; 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		<asp:ImageButton runat="server" id="BtnAdd" ImageUrl="../../images/ButtonAdd.gif" PostBackUrl="SupplierAdd.aspx" />&nbsp;</td>
    </tr>
  </table>
</div>
</form>
