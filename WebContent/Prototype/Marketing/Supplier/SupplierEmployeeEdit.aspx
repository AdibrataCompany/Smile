...
<body>
<form id="FrmSupplierEmployeeEdit" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopihijau">SUPPLIER EMPLOYEE - EDIT</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
      ...
      <td class="style3">
		<font color="red">
		<asp:TextBox runat="server" id="TbsEmployeeName" Width="315px" CssClass="inptype">ALOYSIUS RIWANG</asp:TextBox>
		&nbsp; *)</font> </td>
    </tr>
    <tr> 
	...
	<tr>
      ...
      <td class="tdganjil">
		<textarea name="TbsAddress" rows="5" class="inptype" style="width: 491px" cols="20">Jl. Anggrek No 9</textarea></td>
    </tr>
	<tr>
      <td class="style1" style="width: 51%">RT/RW</td>
      <td class="style3">
		<asp:TextBox runat="server" id="TbsRt" Width="50px" CssClass="inptype">009</asp:TextBox>
&nbsp;/ 
        <asp:TextBox runat="server" id="TbsRw" Width="50px" CssClass="inptype">002</asp:TextBox>
		</td>
    </tr>
	<tr>
      <td class="style1" style="width: 51%">Kelurahan</td>
      <td class="style3">
		<asp:TextBox runat="server" id="TbsKelurahan" Width="200px" CssClass="inptype">Kebon Jeruk</asp:TextBox>
&nbsp;</td>
    </tr>
	<tr>
      <td class="style1" style="width: 51%">Kecamatan</td>
      <td class="style3">
		<asp:TextBox runat="server" id="TbsKecamatan" Width="200px" CssClass="inptype">Kebon Jeruk</asp:TextBox>
&nbsp;</td>
    </tr>
	<tr>
      <td class="style1" style="width: 51%">City</td>
      <td class="style3">
		<asp:TextBox runat="server" id="TbsCity" Width="200px" CssClass="inptype">Jakarta Barat</asp:TextBox>
&nbsp;</td>
    </tr>
	<tr>
      <td class="style1" style="width: 51%">Zip Code</td>
      <td class="style3">
		<asp:TextBox runat="server" id="TbsZipCode" Width="150px" CssClass="inptype">11530</asp:TextBox>
&nbsp;
...
&nbsp;</td>
    ...
    <tr> 
      ...
      <td class="style3">
        <asp:TextBox runat="server" id="TbsAccountNo" Width="200px" CssClass="inptype">2611730839</asp:TextBox>
		</td>
    </tr>
    <tr> 
      <td class="style1" style="width: 25%">Account Name</td>
      <td class="style3">
        <asp:TextBox runat="server" id="TbsAccountName" Width="200px" CssClass="inptype">ALOYSIUS RIWANG</asp:TextBox>
		</td>
    </tr>
    </table>
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
