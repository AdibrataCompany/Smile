...
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopihijau">SUPPLIER - ADD</td>
      <td width="10" class="tdtopihijaukanan">&nbsp;</td>
    </tr>
  </table>
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
      <td class="style1" width="20%">Supplier Group</td>
    ...
    <tr> 
      <td class="style1" width="20%">Supplier Name</td>
      <td colspan="3" class="style3" width="80%">
		<font color="red">
		<asp:TextBox runat="server" id="TbsSupplierName" Width="315px" CssClass="inptype">
		</asp:TextBox>
		&nbsp; *)</font> </td>
    </tr>
...
&nbsp;</td>
    ...
    <tr> 
      <td class="style1" width="20%">Supplier Type</td>
      <td colspan="3" class="style3" width="80%">
		    
			<asp:RadioButtonlist runat="server" id="RdBtnPersonal" RepeatDirection="Horizontal" >
...
&nbsp;</td>
    ...
    <tr> 
      <td class="style1" width="20%">Start Date</td>
      <td class="style3" width="80%">
		<asp:TextBox runat="server" id="TbsPksJoinDate" Width="150px" CssClass="inptype">
		</asp:TextBox>
&nbsp;&nbsp;
    ...
    <tr> 
      ...
      <td class="style3" colspan="3" width="80%">
		<asp:RadioButtonList runat="server" id="RadioButtonList1" RepeatDirection="Horizontal">
			...
			<asp:ListItem Text="OtU"></asp:ListItem>
		</asp:RadioButtonList>
		 </td>
    </tr>
     <tr> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		<asp:ImageButton runat="server" id="BtnSave" ImageUrl="../../images/ButtonSave.gif" PostBackUrl="SupplierAdd2.aspx" />&nbsp;
