...
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopihijau">ADMIN FEE - ADD</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      ...
      <td colspan="3" class="style3"> 
		<asp:DropDownList runat="server" id="ddlProdutType" CssClass="inptype">
			<asp:ListItem>Select One</asp:ListItem>
     ...
     <tr> 
      ...
      <td colspan="3" class="style3">
		<asp:TextBox runat="server" id="txtAssetCategory" Width="150px" CssClass="inptype"></asp:TextBox>
...
&nbsp;<font color="red">*) If Product Type DE Mobil, DE Motor, CF</font></td>
    ...
    <tr> 
      ...
      <td colspan="3" class="style3"> 
		<asp:TextBox runat="server" id="TbsShortName" Width="200px" CssClass="inptype">
     ...
     <tr> 
      ...
      <td colspan="3" class="style3">
			...
			<asp:RadioButtonList runat="server" id="rdbtnSumInsuredBased" RepeatDirection="Horizontal" >
			<asp:ListItem Text="NTF" Value="NTF"></asp:ListItem>
	...
	<tr> 
      ...
      <td colspan="3" class="style3"> 
		<asp:DropDownList runat="server" id="ddlAdminFeeType" CssClass="inptype">
			<asp:ListItem>Select One</asp:ListItem>
	...
	<tr> 
      ...
      <td colspan="3" class="style3">
		<asp:TextBox runat="server" id="txtAmountFundingFrom" Width="200px" CssClass="inptype">
...
<tr>
 <td class="style1" >Amount Funding To</td>
      <td colspan="3" class="style3">
		<asp:TextBox runat="server" id="txtAmountFundingTo" Width="200px" CssClass="inptype">
		</asp:TextBox><font color="red">*) If ProductType = DE Motor</font>
		</td>
		</tr>
    <tr> 
      ...
      <td colspan="3" class="style3">
		<asp:TextBox runat="server" id="txtAdminFeeValue" Width="200px" CssClass="inptype">
		</asp:TextBox>
		</td>
    </tr>
