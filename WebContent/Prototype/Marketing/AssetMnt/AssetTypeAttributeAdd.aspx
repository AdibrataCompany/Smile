...
<body>
<form id="frmAssetAttributeAdd" runat="server">
<div align="center"> 
  ...
  <table border="0" cellpadding="2" cellspacing="1" class="tablegrid" style="width: 95%; height: 38px">
    <tr> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      <td width="10" height="20" class="tdtopihijaukiri">&nbsp;</td>
      <td align="center" class="tdtopihijau">ASSET ATTRIBUTE - ADD</td>
      <td width="10" class="tdtopihijaukanan">&nbsp;</td>
    </tr>
  </table>
  <div align="center">
    <div align="center"> 
      <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
        <tr> 
          ...
          <td class="tdganjil">
			<asp:TextBox runat="server" id="TbsAttributeId" CssClass="inptype"></asp:TextBox>
&nbsp;<font color="red">*)</font> </td>
        </tr>
        <tr> 
          <td class="tdgenap">Attribute Name</td>
          <td class="tdganjil">
			<asp:TextBox runat="server" id="TbsAttributeName" Width="315px" CssClass="inptype">
			</asp:TextBox>
&nbsp;<font color="red">*)</font> </td>
        </tr>
        <tr> 
...
&nbsp;<font color="red">*)</font> </td>
        ...
        <tr> 
          ...
          <td class="tdganjil">
			<asp:TextBox runat="server" id="TbnAttributeLength" CssClass="inptype"></asp:TextBox>
&nbsp;<font color="red">*)</font> </td>
        </tr>
        </table>
    </div>
