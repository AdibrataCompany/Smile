...
<body>
<form id="FrmAssetDocumentListEdit" runat="server">
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      <td width="10" height="20" class="tdtopihijaukiri">&nbsp;</td>
      <td align="center" class="tdtopihijau">ASSET DOCUMENT LIST - EDIT</td>
      <td width="10" class="tdtopihijaukanan">&nbsp;</td>
    </tr>
  </table>
  <div align="center">
    <div align="center"> 
      <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
        <tr> 
          ...
          <td class="tdganjil">BPKB</td>
        </tr>
        <tr> 
          <td class="tdgenap">Document Name</td>
          <td class="tdganjil">
			<asp:TextBox runat="server" id="TbsDocumentName" Width="315px" CssClass="inptype">Bukti Pemilikan Kendaraan</asp:TextBox>
&nbsp; 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		...
		<asp:ImageButton runat="server" id="BtnCancel" ImageUrl="../../images/ButtonCancel.gif" PostBackUrl="AssetTypeDocumentList.aspx" />
		</td>		
    </tr>
  </table>
</div>
