...
<body>
<form id="FrmAssetMasterAddDetail2" runat="server">
<div align="center">
        ...
        <tr> 
          ...
          <td class="tdganjil">
			<asp:DropDownList runat="server" id="CmbAssetCategory" CssClass="inptype">
				<asp:ListItem>Bebek</asp:ListItem>
				<asp:ListItem>Non Bebek</asp:ListItem>
...
&nbsp;<font color="red">*) if asset type automotive/motorcycle, if final level</font> </td>
 ...
 <tr> 
        ...
        <tr> 
          ...
          <td class="tdganjil">
			<asp:TextBox runat="server" id="TbnResaleValue" CssClass="inptype"></asp:TextBox>
&nbsp;<font color="red">*) if final level</font> </td>
        </tr>
        <tr> 
...
&nbsp;<font color="red">*) if final level</font> </td>
        ...
        <tr> 
          ...
          <td class="tdganjil">
          <asp:TextBox runat="server" id="TbxNotes" CssClass="inptype" Height="75px" Width="206px" Rows="10" Columns="50" TextMode="MultiLine" >Asset Code Automotive</asp:TextBox>
<font color="red">*) if final level</font>
			</td>
        </tr>
