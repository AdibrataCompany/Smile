	...
	<body>
		<form id="Form1" method="post" runat="server">
			<div align="center">
					...
					<asp:GridView runat="server" id="GridViewPersonalCustomer" DataSourceID="XmlDataSource1" AutoGenerateColumns="False" Width="95%" >
						<Columns>
					...
					<asp:GridView runat="server" id="GridViewPersonalCustomer4" DataSourceID="XmlDataSource1" AutoGenerateColumns="False" Width="95%" >
						<Columns>
						<asp:boundfield DataField="valnumber2" SortExpression="valnumber" HeaderText="NO">
