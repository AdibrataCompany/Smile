...
<table width="95%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td colspan="3"><font color="red"><i>Notes : yang muncul checkbox adalah yang statusnya closed dan prospect saja 
      <br>
      </i></font></td>
    </tr>
  </table>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopihijau">TSE SUPERVISOR ACTIVITY</td>
 ...
 <tr>
      ...
      <td width="80%" class="tdganjil" style="height: 25px">
		<asp:DropDownList runat="server" id="DDLStatus" Width="97px" Height="17px">
			<asp:ListItem>Select One</asp:ListItem>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
  		  <asp:ImageButton runat="server" ID="imbUnAssign" ImageUrl="../../images/ButtonNext.gif" PostBackUrl="TseSupervisorActivityProcess.aspx"></asp:ImageButton>
      </td>
    </tr>
  </table>
</div>
