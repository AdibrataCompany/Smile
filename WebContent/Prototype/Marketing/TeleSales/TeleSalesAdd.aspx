...
<div align="center"> 
  <table width="95%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td colspan="3"><font color="red"><i>*) required field</i><br>Detail Address ditampilkan berdasarkan data pada BranchEmployee</font></td>
    </tr>
  </table>
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      <td width="10" height="20" class="tdtopihijaukiri">&nbsp;</td>
      <td align="center" class="tdtopihijau">TELE SALES - ADD</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
     ...
     <tr>
      ...
      <td class="tdganjil" width="80%"> 
		<asp:TextBox runat="server" id="TBxTseId" Width="104px" CssClass="inptype" TabIndex="1"></asp:TextBox>
		<font color="red">
		&nbsp;<asp:Hyperlink  ImageUrl="../../Images/IconDetail.gif" ID="ucEmployee" runat="server" NavigateUrl="../../Lookup/EmployeeLookup.htm" Target="_blank"></asp:Hyperlink>
      *)</font> </td>
    </tr>
     ...
     <tr> 
      ...
      <td class="tdganjil" width="80%"> 
		<asp:DropDownList runat="server" id="DropDownList2">
			...
			<asp:ListItem>KITAS</asp:ListItem>
		</asp:DropDownList>
		</td>
     </tr>
     <tr> 
      ...
      <td class="tdganjil" width="80%"> 
		<asp:TextBox runat="server" id="txtIDNumber" Width="326px" CssClass="inptype" TabIndex="16">
		</asp:TextBox>
		</td>
    </tr>
     <tr> 
     ...
     <tr> 
      ...
      <td class="tdganjil" width="80%"> 
		<asp:DropDownList runat="server" id="DropDownList1" TabIndex="30">
