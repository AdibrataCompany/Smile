...
<body>
<form id="FrmStatusApPaymentToDealer" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopihijau"> 
      ...
      <td align="center" class="tdtopihijau2">STATUS AP PAYMENT TO DEALER REPORT</td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right">
		&nbsp;&nbsp;&nbsp; 
        <asp:ImageButton runat="server" id="BtnViewReport" ImageUrl="../../../images/ButtonViewReport.gif" PostBackUrl="ReportStatusApPaymentDealer.aspx" />&nbsp;</td>
    </tr>
  </table>
</div>
</form>
