...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiabu">CLAIM ACTIVITY LISTING</td>
      <td width="10">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="ACTIVITY">
			<AlternatingItemTemplate>
				<asp:ImageButton runat="server" id="btnActivity" ImageUrl="../../images/IconActivity.gif" PostBackUrl="ClaimActivityResult.aspx" />
			</AlternatingItemTemplate>
			<ItemTemplate>
				<asp:ImageButton runat="server" id="btnActivity" ImageUrl="../../images/IconActivity.gif" PostBackUrl="ClaimActivityResult.aspx" />
			</ItemTemplate>
