...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiabu">CLAIM ACTIVITY DETAIL LISTING</td>
      <td width="10">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="REJECT">
			<AlternatingItemTemplate>
				<asp:ImageButton runat="server" id="btnReject" ImageUrl="../../images/IconNegCov.gif" PostBackUrl="ClaimActivityReject.aspx" />
			</AlternatingItemTemplate>
			<ItemTemplate>
				<asp:ImageButton runat="server" id="btnReject" ImageUrl="../../images/IconNegCov.gif" PostBackUrl="ClaimActivityReject.aspx" />
			</ItemTemplate>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="50%" height="30">
		<asp:ImageButton runat="server" id="imbBack" ImageUrl="../../images/buttonBack.gif" PostBackUrl="ClaimActivityRejectList.aspx"/></td>
