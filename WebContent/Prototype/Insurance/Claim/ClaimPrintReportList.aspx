...
<div align="center">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiabu">PRINT CLAIM REPORT</td>
      <td width="10">
...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="EDIT">
			<AlternatingItemTemplate>
				<asp:ImageButton runat="server" id="btnEdit" ImageUrl="../../images/IconEdit.gif" PostBackUrl="ClaimPrintReportListDtl.aspx" />
			</AlternatingItemTemplate>
			<ItemTemplate>
				<asp:ImageButton runat="server" id="btnEdit" ImageUrl="../../images/IconEdit.gif" PostBackUrl="ClaimPrintReportListDtl.aspx" />
			</ItemTemplate>
