...
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      <td width="10" height="20">
		<img src="../../Images/AbuKiri.gif" width="10" height="21"></td>
      <td align="center" class="tdtopiabu">CLAIM REQUEST LISTING</td>
      <td width="10">
		<img src="../../Images/AbuKanan.gif" width="10" height="21"></td>
    </tr>
  </table>
    ...
    <Columns>
		...
		<asp:templatefield HeaderText="ASSET">
			<AlternatingItemTemplate>
				<asp:ImageButton runat="server" id="btnClaim" ImageUrl="../../images/IconClaim.gif" PostBackUrl="ClaimRequestAsset.aspx" />
			</AlternatingItemTemplate>
			<ItemTemplate>
				<asp:ImageButton runat="server" id="btnClaim" ImageUrl="../../images/IconClaim.gif" PostBackUrl="ClaimRequestAsset.aspx" />
			</ItemTemplate>
