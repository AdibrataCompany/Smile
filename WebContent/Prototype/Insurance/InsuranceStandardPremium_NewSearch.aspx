			...
			<br>
				...
				<asp:DataGrid id="dtgPaging" runat="server" Width="95%" AllowSorting="True" AutoGenerateColumns="False" BorderWidth="0px" cellpadding="3" cellspacing="1" CssClass="tablegrid" DataSourceID="xmlRate">
					...
					<Columns>
						...
						<asp:templatecolumn HeaderText="STANDARD RATE">
							<ItemTemplate>
								<a href='InsStdPremRateSetting.aspx'>
	...
	&nbsp;record(s)</FONT>
	 			...
	 			<table width="95%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<a href="Report/RptInsStdRate_New.htm">
     					 <img src="../Images/ButtonPrint.gif" width="100" height="20" border="0"></a>											
     					 </td>
					</tr>
				</table>
