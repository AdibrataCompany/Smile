				...
				<asp:Panel id="pnlList" runat="server" width="100%" horizontalalign="center">
					...
					<asp:DataGrid id="dtgPaging" runat="server" width="100%" cssclass="tablegrid" allowsorting="True" autogeneratecolumns="False" borderwidth="0px" cellpadding="3" cellspacing="1" DataSourceID="XmlRate">
						...
						<Columns>
							...
							<asp:templatecolumn HeaderText="YEAR NUM">
								<ItemTemplate>
									<asp:Label runat="server" Text='<%# Eval("valid") %>' id="lblyear">
									</asp:Label>
								</ItemTemplate>
							</asp:templatecolumn>
							...
							<asp:templatecolumn HeaderText="EDIT">
								...
								<ItemTemplate>
									<asp:ImageButton id="imgEdit" runat="server" causesvalidation="False" imageurl="../images/IconEdit.gif" commandname="Edit" PostBackUrl="InsStdPremEdit.aspx" />
								</ItemTemplate>
							</asp:templatecolumn>
					...
					<TR>
					<TD align="left">
					 <a href="Report/RptInsStdRate.htm"><img src="../Images/buttonPrint.gif" width="100" height="20" border="0"></a>    
					</TD>
					<TD align="right">
					<asp:ImageButton id="imbAdd" runat="server" imageurl="../images/ButtonAdd.gif" causesvalidation="False" PostBackUrl="InsStdPremAdd.aspx" />
