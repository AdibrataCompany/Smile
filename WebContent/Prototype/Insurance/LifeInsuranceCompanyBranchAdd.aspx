...
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiabu">LIFE INSURANCE COMPANY BRANCH - ADD</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      ...
      <td class="tdganjil"> 
			...
			<asp:ListItem>Palmerah</asp:ListItem>
    ...
    <tr> 
      ...
      <td class="tdganjil"> 
        <asp:TextBox runat="server" id="txtInsCoBranchID" CssClass="inptype">
		</asp:TextBox>
    ...
    <tr> 
     ...
     <tr> 
      <td class="tdgenap">Copy Data Insco Branch&nbsp; From Branch</td>
      <td class="tdganjil">  
        <asp:TextBox runat="server" id="txtCopyInsCoBranch" CssClass="inptype">
		</asp:TextBox>
...
&nbsp;<a href="javascript:;" onClick="MM_openBrWindow('../Lookup/BankMasterLookup.htm','ZipCode','scrollbars=yes,width=900,height=500')"><img src="../Images/IconDetail.gif" width="15" height="15" align="absmiddle" border="0"></a> 
  ...
  <tr> 
    ...
    <tr> 
      ...
      <td class="tdganjil"> 
        <font face="Tahoma, Verdana" size="2"> 
        <asp:TextBox runat="server" id="txtTermOfPay" CssClass="inptype" Width="60px">
		365
		</asp:TextBox>
		</font>&nbsp;days</td>
    </tr>
    ...
    <tr>
		<TD class="tdgenap" style="HEIGHT: 22px" width="25%">Tolerance Amount</TD>
		<TD class="tdganjil" style="HEIGHT: 2px">
        <font face="Tahoma, Verdana" size="2"> 
        <asp:TextBox runat="server" id="txtToleranceAmt" CssClass="inptype" Width="110px">
		</asp:TextBox>
		</font></TD>
	</tr>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right"> 
		<asp:ImageButton runat="server" id="imbSave" imageUrl="../images/buttonSave.gif" PostBackUrl="LifeInsuranceCompanySettingBranch.aspx"/>
		<asp:ImageButton runat="server" id="ImbCancel" imageUrl="../images/buttonCancel.gif" PostBackUrl="LifeInsuranceCompanySettingBranch.aspx" />
	  </td>
    </tr>
  </table>
</div>
