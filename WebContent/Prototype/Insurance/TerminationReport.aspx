...
<form id="form1" runat="server">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiabu">TERMINATION REPORT</td>
   ...
   <tr> 
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td> 
            <div align="right">
			<a href="Report/TerminationReport.htm">	
         <img src="../Images/ButtonViewReport.gif" width="100" height="20" border="0"></a></div></td>
        </tr>
      </table>
