    ...
    <tr class="trtopiabu"> 
      ...
      <td class="tdganjil"><a href="javascript:;" onClick="MM_openBrWindow('../Credit/ViewPersonalCustomer.htm','Customer','scrollbars=yes,width=900,height=700,top=1,left=1')">xxxxxxxxxx50xxxxxxxxxx</a></td>
        ...
        <tr> 
		 ...
		 <tr> 
          <td class="tdgenap" style="height: 18px">Asset Used New</td>
          <td class="tdganjil" style="width: 34%; height: 18px;">xxxx</td>
          <td class="tdgenap" style="height: 18px">Tenor</td>
          <td class="tdganjil" style="height: 18px">xxxx10xxxx</td>
        </tr>
		 <tr> 
...
<br>
 <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      <td width="10" height="20" class="tdtopiabukiri">&nbsp;</td>
      <td align="center" class="tdtopiabu"> PREMIUM TO INSCO</td>
      <td width="10" class="tdtopiabukanan">&nbsp;</td>
    </tr>
  </table>     
<asp:GridView runat="server" id="gridinsco" AutoGenerateColumns="False" DataSourceID="xmlinsco" Width="95%">
	<Columns>
		<asp:boundfield DataField="valstring3" SortExpression="valstring3" HeaderText="YEAR">
			<HeaderStyle CssClass="tdjudulabu" />
		</asp:boundfield>
		...
		<asp:boundfield DataField="valstring3" SortExpression="valstring3" HeaderText="COVERAGE">
			<HeaderStyle CssClass="TDJUDULABU" />
		</asp:boundfield>
		<asp:boundfield DataField="valamount" SortExpression="valamount" HeaderText="PREMIUM">
			<HeaderStyle CssClass="TDJUDULABU" />
		</asp:boundfield>
		<asp:boundfield DataField="valamount" SortExpression="valamount" HeaderText="TPL AMOUNT">
			<HeaderStyle CssClass="TDJUDULABU" />
		</asp:boundfield>
		<asp:boundfield DataField="valamount" SortExpression="valamount" HeaderText="TPL PREMIUM">
			<HeaderStyle CssClass="TDJUDULABU" />
		</asp:boundfield>
		<asp:boundfield DataField="valstring3" SortExpression="valstring3" HeaderText="SRCC">
			<HeaderStyle CssClass="TDJUDULABU" />
		</asp:boundfield>
		<asp:boundfield DataField="valamount" SortExpression="valamount" HeaderText="SRCC PREMIUM">
			<HeaderStyle CssClass="TDJUDULABU" />
		</asp:boundfield>
		<asp:boundfield DataField="valstring3" SortExpression="valstring3" HeaderText="FLOOD">
			<HeaderStyle CssClass="TDJUDULABU" />
		</asp:boundfield>
		<asp:boundfield DataField="valamount" SortExpression="valamount" HeaderText="FLOOD PREMIUM">
			<HeaderStyle CssClass="TDJUDULABU" />
	...
	<asp:XmlDataSource runat="server" ID="xmlInsco" DataFile="../DataType.xml">
	</asp:XmlDataSource>
 ...
 <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td align="right">
		 ...
		 <a href="NewCoverForExistingApp.aspx"><img src="../Images/ButtonCancel.gif" width="100" height="20" border="0"></a> 
       </td>
    </tr>
  </table>
  <TABLE cellSpacing="0" cellPadding="0" width="95%" align="center" border="0">
					<TR class="trtopi">
						...
						<TD class="tdtopi" align="center">PREMIUM TO CUSTOMER
						</TD>
				...
				<TABLE class="tablegrid" cellSpacing="1" cellPadding="3" width="95%" align="center" border="0">
					...
					<TR>
						<TD class="tdgenap">Premium To Customer</TD>
						<TD class="tdganjil" align="right">
							&nbsp;999,999,999</TD>
						<TD class="tdgenap"></TD>
						<TD class="tdganjil"></TD>
  ...
  <TABLE cellSpacing="0" cellPadding="0" width="95%" align="center" border="0">
					<TR class="trtopi">
						<TD class="tdtopikiri" width="10" height="20">&nbsp;</TD>
						<TD class="tdtopi" align="center">PREMIUM TO INSCO</TD>
						<TD class="tdtopikanan" width="10">&nbsp;</TD>
					</TR>
				</TABLE>
				<TABLE class="tablegrid" cellSpacing="1" cellPadding="3" width="95%" align="center" border="0">
 ...
 <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="30">&nbsp;</td>
      <td align="right">
		 <a href="NewCoverAssetNext.aspx"><img src="../Images/buttonsave.gif" width="100" height="20" border="0"></a>      
		 <a href="NewCoverForExistingApp.aspx"><img src="../Images/ButtonCancel.gif" width="100" height="20" border="0"></a> 
       </td>
    </tr>
  </table>
