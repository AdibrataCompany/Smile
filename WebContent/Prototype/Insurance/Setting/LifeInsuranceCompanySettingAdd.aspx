...
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiabu">LIFE INSURANCE COMPANY SETTING - ADD</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
      ...
      <td class="tdganjil"> 
		<asp:TextBox runat="server" id="txtInsCoId" CssClass="inptype" Width="100px">PANIN</asp:TextBox>
		&nbsp;<font color="red">*)</font> 
		</td>
    </tr>
    <tr>
...
&nbsp;</font></td>
    ...
    <TR class="tdganjil">
        ...
        <asp:TextBox runat="server" id="txtDaysInYear" CssClass="inptype" Width="60px">
		</asp:TextBox>
			</font></TD>
	</TR>
    ...
    <TR class="tdganjil">
		...
		<TD class="tdganjil" style="HEIGHT: 2px">
			<font face="Tahoma, Verdana" size="2"> 
        <asp:TextBox runat="server" id="txtDaysInYear0" CssClass="inptype" Width="150px">
		</asp:TextBox>
			</font></TD>
	</TR>
