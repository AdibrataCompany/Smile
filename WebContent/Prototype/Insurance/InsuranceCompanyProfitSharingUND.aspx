...
<form id="form1" runat="server">
 <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiabu">PROFIT SHARING&nbsp; - EDIT</td>
...
<table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
   ...
   <table width="95%" border="0" cellpadding="3" cellspacing="1" class="tablegrid">
    <tr align="center" class="tdjudulabu"> 
      ...
      <td width="12%">
		<input name="Text2" type="text" class="inptype" style="width: 70px" value="29.99" /></td>
      <td width="15%">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right"><a href="insurancecompanyprofitsharing.aspx"><img src="../Images/ButtonSave.gif" width="100" height="20" border="0"></a> 
