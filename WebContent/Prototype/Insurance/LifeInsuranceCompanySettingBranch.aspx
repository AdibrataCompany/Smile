...
<form id="form1" runat="server">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiabu">LIFE INSURANCE COMPANY BRANCH</td>
  ...
  <Columns>
	<asp:boundfield DataField="valstring10" HeaderText="INSCO. BRANCH" SortExpression="valstring10">
	</asp:boundfield>
	...
	<asp:templatefield HeaderText="FEE">
		<AlternatingItemTemplate>
			<asp:HyperLink runat="server" ImageUrl="../images/iconRate.gif" NavigateUrl="LifeInsuranceCompanyBranchFee.htm" />
		</AlternatingItemTemplate>
		<ItemTemplate>
			<asp:HyperLink runat="server" ImageUrl="../images/iconRate.gif" NavigateUrl="LifeInsuranceCompanyBranchFee.htm" />
		</ItemTemplate>
	...
	<asp:templatefield HeaderText="RATE">
		<AlternatingItemTemplate>
			<asp:ImageButton runat="server" ImageUrl="../images/iconRate.gif" PostbackUrl="LifeInsuranceCompanyBranchRate.aspx" />
		</AlternatingItemTemplate>
		<ItemTemplate>
			<asp:ImageButton runat="server" ImageUrl="../images/iconRate.gif" PostbackUrl="LifeInsuranceCompanyBranchRate.aspx" />
		</ItemTemplate>
	...
	<asp:templatefield HeaderText="EDIT">
		<AlternatingItemTemplate>
			<asp:ImageButton runat="server" ImageUrl="../images/iconEdit.gif" PostbackUrl="LifeInsuranceCompanyBranchEdit.aspx" />
		</AlternatingItemTemplate>
		<ItemTemplate>
			<asp:ImageButton runat="server" ImageUrl="../images/iconEdit.gif" PostbackUrl="LifeInsuranceCompanyBranchEdit.aspx" />
		</ItemTemplate>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="50%" align="right">
      	<asp:ImageButton runat="server" id="imbAdd" ImageUrl="../images/buttonAdd.gif" PostBackUrl="LifeInsuranceCompanyBranchAdd.aspx"></asp:ImageButton>
      	<asp:ImageButton runat="server" id="imbBack" ImageUrl="../images/buttonBack.gif" PostBackUrl="LifeInsuranceCompanySetting.aspx"></asp:ImageButton>
    </tr>
  </table>
</form>  
</div>
