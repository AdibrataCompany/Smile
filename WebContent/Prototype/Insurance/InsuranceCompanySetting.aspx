...
<div align="center">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiabu">INSURANCE COMPANY SETTING</td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      <td width="10" height="20"><img src="../Images/AbuKiri.gif" width="10" height="21"></td>
      <td align="center" class="tdtopiabu">INSURANCE COMPANY LISTING</td>
      <td width="10"><img src="../Images/AbuKanan.gif" width="10" height="21"></td>
    </tr>
  </table>
 <asp:GridView runat="server" id="GrdViewInsCoSetting" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%">
  <Columns>
	<asp:templatefield HeaderText="INSCO. BRANCH">
		<AlternatingItemTemplate>
			<asp:hyperlink  runat="server" Text="xxxxx10xxxxx" NavigateUrl="InsuranceCompanyView.htm" target="_blank"/>
		</AlternatingItemTemplate>
		<ItemTemplate>
			<asp:hyperlink  runat="server" Text="xxxxx10xxxxx" NavigateUrl="InsuranceCompanyView.htm" target="_blank"/>
		</ItemTemplate>
	...
	<asp:templatefield HeaderText="BRANCH">
		<AlternatingItemTemplate>
			<asp:ImageButton runat="server" ImageUrl="../images/IconBranch.gif" PostBackUrl="InsuranceCompanySettingBranch.aspx" />
		</AlternatingItemTemplate>
		<ItemTemplate>
			<asp:ImageButton runat="server" ImageUrl="../images/IconBranch.gif" PostBackUrl="InsuranceCompanySettingBranch.aspx" />
		</ItemTemplate>
	...
	<asp:templatefield HeaderText="EDIT">
		<AlternatingItemTemplate>
			<asp:ImageButton runat="server" ImageUrl="../images/iconEdit.gif" PostBackUrl="InsuranceCompanySettingEdit.aspx" />
		</AlternatingItemTemplate>
		<ItemTemplate>
			<asp:ImageButton runat="server" ImageUrl="../images/iconEdit.gif" PostBackUrl="InsuranceCompanySettingEdit.aspx" />
		</ItemTemplate>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="50%" align="right"><asp:ImageButton runat="server" id="imbAdd" ImageUrl ="../images/ButtonAdd.gif" PostBackUrl="InsuranceCompanySettingAdd.aspx"></asp:ImageButton></td>
    </tr>
  </table>
</div>
</form>
