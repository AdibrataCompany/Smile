...
<form id="form1" runat="server">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiabu">LIFE INSURANCE COMPANY BRANCH RATE</td>
...
&nbsp;<a href="javascript:;" onClick="MM_openBrWindow('../Lookup/InsCoBranchLookup.htm','InsCoBranch','scrollbars=yes,width=900,height=500')"><img src="../Images/IconDetail.gif" width="15" height="15" border="0"></a>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
     ...
     <asp:GridView runat="server" id="GrdInsCoBranchRate" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%">
		<Columns>
			<asp:boundfield DataField="valstring10" HeaderText="GENDER" SortExpression="valstring10">
			</asp:boundfield>
			<asp:boundfield DataField="valNum3" HeaderText="TENOR (mths)" SortExpression="valNum3">
				<ItemStyle HorizontalAlign="Right" />
			</asp:boundfield>
			<asp:boundfield DataField="valNum3" HeaderText="AGE (yrs)" SortExpression="valNum3">
				<ItemStyle HorizontalAlign="Right" />
			</asp:boundfield>
			...
			<asp:templatefield HeaderText="EDIT">
				<AlternatingItemTemplate>
					<asp:ImageButton runat="server" id="BtnIcoEdit" ImageUrl="../images/IconEdit.gif" PostBackUrl="LifeInsuranceCompanyBranchRateEdit.aspx" />
				</AlternatingItemTemplate>
				<ItemTemplate>
					<asp:ImageButton runat="server" id="BtnIcoEdit" ImageUrl="../images/IconEdit.gif" PostBackUrl="LifeInsuranceCompanyBranchRateEdit.aspx" />
				</ItemTemplate>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="50%" align="right">&nbsp;<asp:ImageButton runat="server" id="imbAdd" imageUrl="../images/buttonAdd.gif" PostBackUrl="LifeInsuranceCompanyBranchRateAdd.aspx"/><asp:ImageButton runat="server" id="imbBack" ImageUrl="../images/buttonBack.gif" PostBackUrl="InsuranceCompanySettingBranch.aspx"/></td>
    </tr>
  </table>
</form>  
</div>
