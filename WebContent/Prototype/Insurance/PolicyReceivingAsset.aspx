...
<div align="center">
  ...
  <div align="center">
    <div align="center">
      ...
      <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
        <tr> 
          <td width="150" align="center" class="tdjudulabu" style="height: 18px">YEAR NUM</td>
          <td align="center" class="tdjudulabu" style="height: 18px; width: 141px;">SUM INSURED 
			AMOUNT</td>
          <td align="center" class="tdjudulabu" style="height: 18px">COVERAGE TYPE</td>
          <td align="center" class="tdjudulabu" style="height: 18px">SRCC</td>
          <td align="center" class="tdjudulabu" style="height: 18px">TPL</td>
          <td align="center" class="tdjudulabu" style="height: 18px">FLOOD</td>
          <td align="center" class="tdjudulabu" style="height: 18px">IS VALID</td>
        </tr>
        <tr> 
          <td align="center" class="tdganjil">1</td>
          <td align="right" class="tdganjil" style="width: 141px">99,999,999</td>
          <td align="center" class="tdganjil">xxxx10xxxx</td>
          <td align="right" class="tdganjil">99,999,999</td>
          <td align="right" class="tdganjil">99,999,999</td>
          <td align="right" class="tdganjil">99,999,999</td>
          <td align="center" class="tdganjil"><input name="checkbox22" type="checkbox" value="checkbox" checked></td>
        </tr>
        <tr> 
          <td align="center" class="tdgenap">2</td>
          <td align="right" class="tdgenap" style="width: 141px">99,999,999</td>
          <td align="center" class="tdgenap">xxxx10xxxx</td>
          <td align="right" class="tdgenap">99,999,999</td>
          <td align="right" class="tdgenap">99,999,999</td>
          <td align="right" class="tdgenap">99,999,999</td>
          <td align="center" class="tdganjil"><input name="checkbox2" type="checkbox" value="checkbox" checked></td>
        </tr>
        <tr> 
          <td align="center" class="tdganjil">3</td>
          <td align="right" class="tdganjil" style="width: 141px">99,999,999</td>
          <td align="center" class="tdganjil">xxxx10xxxx</td>
          <td align="right" class="tdganjil">99,999,999</td>
          <td align="right" class="tdganjil">99,999,999</td>
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <a href="PolicyReceivingReceiveValid.htm"><img src="../Images/Buttonvalidate.gif" width="100" height="20" border="0"></a>
          <a href="PolicyReceivingReceive.aspx"><img src="../Images/ButtonBack.gif" width="100" height="20" border="0"></a> 
          </td>
        </tr>
      </table>
    </div>
