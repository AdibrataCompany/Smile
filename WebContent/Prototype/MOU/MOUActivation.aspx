...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<asp:GridView Width="95%" runat="server" id="grdMou" DataSourceID="XmlDataSource2" AutoGenerateColumns="False">
					<Columns>
						...
						<asp:templatefield HeaderText="ACTIVATE">
							<ItemTemplate>
								<asp:HyperLink runat="server" id="hypActivate" NavigateUrl="MouActivationNext.aspx" Text="Activate" />
							</ItemTemplate>
							<ItemStyle HorizontalAlign="Center" />
						</asp:templatefield>
					</Columns>
			...
			<p align="center"><font color="red" face="Arial, Helvetica, sans-serif">Select yang statusnya APR saja</font></p>
	</body>
</HTML>
