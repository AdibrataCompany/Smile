	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:panel id="pnlAdd" runat="server">
				...
				<TD class="tdtopihijau" align="center">MOU MAINTENANCE - EDIT</TD>
				...
				<TD class="tdganjil" id="lblcustomerid">
				<asp:TextBox runat="server" id="txtCustName" CssClass="inptype" Width="250px" Enabled="false">ADICIPTA INOVASI
				</asp:TextBox>
				...
				<TD class="tdganjil">
				<asp:TextBox runat="server" id="txtMouDate" CssClass="inptype" Width="100px" Enabled="false">dd-mm-yyyy
				</asp:TextBox>
				...
				<TD class="tdganjil">
				<asp:TextBox runat="server" id="txtExpiredDate" CssClass="inptype" Width="100px">dd-mm-yyyy
				</asp:TextBox>
				...
				<TD class="tdganjil">
				<asp:TextBox id="txtReffNo" runat="server" CssClass="inptype" Width="200px">xxxxx20xxxxx
				</asp:TextBox>
				</TD>
				</TR>
				<TR>
				...
				<TD class="tdganjil">
				<asp:CheckBox id="chkIsPlafond" runat="server" Checked="True" Enabled="false"/>
				</TD>
				</TR>
				<TR>
				<TD class="tdgenap" width="25%">Plafond Amount</TD>
				<TD class="tdganjil">
				<asp:TextBox id="txtPlafondAmount" runat="server" CssClass="inptype" Enabled="false">0
				</asp:TextBox>
				&nbsp;<FONT color="red">*)</FONT>
				<asp:RequiredFieldValidator id="rfvPlafondAmount" runat="server" font-name="Verdana" font-size="11px" controltovalidate="txtPlafondAmount" errormessage="Please Fill Plafond Amount" display="Dynamic">
				</asp:RequiredFieldValidator>
				<asp:RangeValidator id="rgvPlafondAmount" runat="server" ControlToValidate="txtPlafondAmount" Type="Double" MinimumValue="0" ErrorMessage="Plafond Amount must be &gt; 0 !" Display="Dynamic" MaximumValue="99999999999999999">
				</asp:RangeValidator>
				</TD>
				</TR>
				<TR>
				...
				<TABLE id="Table9" cellSpacing="0" cellPadding="0" width="95%" align="center" border="0">
					<TR>
						<TD align="right">
							<asp:imagebutton id="btnSaveAdd" runat="server" imageurl="../Images/ButtonSave.gif" causesvalidation="True" PostBackUrl="MouList.aspx"></asp:imagebutton>
