...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<TD class="tdtopihijau" align="center">MOU - VIEW</TD>
         ...
         &nbsp;
				...
				<TR>
				<TD align="right">
				<asp:ImageButton id="btnClose" runat="server" imageurl="../Images/ButtonClose.gif" causesvalidation="False" PostBackUrl="javascript:window.close();" />
				</TD>
				</TR>
				</TABLE>
		</form>
