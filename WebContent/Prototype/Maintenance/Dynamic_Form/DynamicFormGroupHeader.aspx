<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DynamicFormGroupHeader.aspx.cs" Inherits="Dynamic_Form_DynamicFormGroupHeader" %>
...
<body>
     ...
     <asp:Panel ID="pnlInput" runat="server" Width="100%">
       		<TABLE cellSpacing="0" cellPadding="0" width="95%" align="center" border="0">
				<TR class="trtopikuning">
					...
					<TD class="tdtopi" align="center">DYNAMIC FORM GROUP HEADER ADD</TD>
					<TD class="tdtopikanan" width="10">&nbsp;</TD>
				</TR>
			</TABLE>
        <table class="tablegrid" cellspacing="1" cellpadding="3" width="95%" align="center" border="0">
            <tr>
                <td width='25%' class='tdgenap'>Group ID</td>
                <td class='tdganjil'>                    
                    <asp:TextBox ID="txtGroupID" runat="server" CssClass="inptype"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvGroupID" runat="server" ControlToValidate="txtGroupID"
       ...
       <table align="center" border="0" cellpadding="0" cellspacing="0" width="95%">
            <tr>
                <td align="right">
                    <asp:ImageButton ID="btnNext" ImageUrl="~/Images/ButtonNext.gif" runat="server" 
    ...
    <asp:Panel ID="pnlTop" runat="server" Width="100%">
				...
				<TR class="trtopikuning">
					<TD class="tdtopikiri" width="10" height="20">&nbsp;</TD>
					<TD class="tdtopi" align="center">DYNAMIC FORM GROUP HEADER</TD>
					<TD class="tdtopikanan" width="10">&nbsp;</TD>
				</TR>
			</TABLE>
            <table class="tablegrid" cellspacing="0" cellpadding="0" width="95%" align="center" border="0">
                <tr>
                    <td width = "25%" class="tdganjil">Group ID :</td> 
                    <td class='tdganjil'>                        
    ...
    <asp:Panel ID="pnlHeaderList" runat="server" Width="100%" Visible="false">
            <TABLE cellSpacing="0" cellPadding="0" width="95%" align="center" border="0">
				<TR class="trtopikuning">
					<TD class="tdtopikiri" width="10" height="20">&nbsp;</TD>
					<TD class="tdtopi" align="center">DYNAMIC FORM GROUP HEADER LIST</TD>
					<TD class="tdtopikanan" width="10">&nbsp;</TD>
				</TR>
			</TABLE>
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="95%">
                <tr align="center">
                    <td>
                        <asp:DataGrid ID="ListDG" runat="server" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateColumn HeaderText="GROUP ID" SortExpression="GroupID">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblGroupID" runat="server" Enabled="True" Text='<%# DataBinder.Eval(Container.DataItem, "GroupID")%>'>
											</asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
