<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DynamicFormGroup.aspx.cs" Inherits="Dynamic_Form_DynamicFormGroup" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="tablegrid" cellspacing="1" cellpadding="3" width="95%" align="center" border="0">
            ...
            <tr>
                <td width='25%' class='tdgenap' >On Edit Disabled</td>
                <td class='tdganjil'>
                    <asp:CheckBox ID="cbOnEdit" runat="server"  />
                </td>
            </tr>
            <tr>
                    ...
                    <asp:DataGrid ID="ListDG" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            <asp:TemplateColumn HeaderText="GROUP ID" SortExpression="GroupID">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="GroupID" runat="server" Enabled="True" 
                                    Text='<%# DataBinder.Eval(Container.DataItem, "GroupID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
