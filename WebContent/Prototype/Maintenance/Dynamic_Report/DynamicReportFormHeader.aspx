<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DynamicReportFormHeader.aspx.cs" Inherits="Dynamic_Report_DynamicReportFormHeader" %>
...
<head id="Head1" runat="server">
    ...
    <title>Dynamic Report Form Header</title>
</head>
<body>
    ...
    <div>
       <asp:Panel ID="pnlInput" runat="server" Width="100%">
				...
				<TR class="trtopikuning">
					...
					<TD class="tdtopi" align="center">DYNAMIC REPORT FORM HEADER DETAIL</TD>
...
<asp:ImageButton ID="btnSave" ImageUrl="~/Images/ButtonSave.gif" runat="server" 
    ...
    <asp:Panel ID="pnlTop" runat="server" Width="100%">
				...
				<TR class="trtopikuning">
					<TD class="tdtopikiri" width="10" height="20">&nbsp;</TD>
					<TD class="tdtopi" align="center">DYNAMIC REPORT FORM HEADER</TD>
					<TD class="tdtopikanan" width="10">&nbsp;</TD>
				</TR>
			</TABLE>
    ...
    <asp:Panel ID="pnlHeaderList" runat="server" Width="100%" Visible="false">
            <TABLE cellSpacing="0" cellPadding="0" width="95%" align="center" border="0">
				<TR class="trtopikuning">
					<TD class="tdtopikiri" width="10" height="20">&nbsp;</TD>
					<TD class="tdtopi" align="center">DYNAMIC REPORT FORM HEADER LIST</TD>
					<TD class="tdtopikanan" width="10">&nbsp;</TD>
				</TR>
			</TABLE>
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="95%">
