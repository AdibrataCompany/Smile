<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DynamicReportParameter.aspx.cs" Inherits="DynamicReportParameter" %>
    ...
    <div>
       ...
       <table cellspacing="0" cellpadding="0" width="95%" align="center" border="0">
                    ...
                    <td style="width: 100%">
                        <asp:DataGrid ID="ListDG" runat="server" AllowPaging="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="PARAMETER NAME" SortExpression="ParameterName">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblParameterName" runat="server" Enabled="True" Text='<%# DataBinder.Eval(Container.DataItem, "ParameterName")%>'>
											</asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="PARAMETER VARIABLE" SortExpression="ParameterVariable">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblParameterVariable" runat="server" Enabled="True" Text='<%# DataBinder.Eval(Container.DataItem, "ParameterVariable")%>'>
											</asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
        ...
        <asp:Panel ID="pnlHeaderList" runat="server" Width="100%" Visible="false">
            ...
            <tr>
                <td class='tdgenap' style="width: 25%">Parameter Name</td>
                <td class='tdganjil'>
                    <asp:TextBox ID="txtParameterName" runat="server" MaxLength="100"></asp:TextBox>
                    <asp:Label ID="lblParameterName" runat="server"></asp:Label>
                    <font color="#FF0000">*)</font><asp:RequiredFieldValidator
                        ID="reqParameterName" runat="server" ErrorMessage="Please fill Parameter Name" ControlToValidate="txtParameterName"></asp:RequiredFieldValidator>
                    
                </td>
            </tr>
            <tr>
                <td class='tdgenap'>Parameter Variable</td>
                <td class='tdganjil'>
                    <asp:TextBox ID="txtParameterVariable" runat="server" MaxLength="100"></asp:TextBox><font color="#FF0000">*)</font><asp:RequiredFieldValidator
                        ID="reqParameterVariable" runat="server" ErrorMessage="Please fill Parameter Variable" ControlToValidate="txtParameterVariable"></asp:RequiredFieldValidator>
                </td>
            </tr>
        </table>
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="95%">
