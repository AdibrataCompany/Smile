...
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiorange">BRANCH - ADD</td>
    ...
    <div align="center"> 
      <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
        <tr> 
          ...
          <td class="style3">
			<asp:TextBox runat="server" id="TbsBranchId" CssClass="inptype"></asp:TextBox>
&nbsp;<font color="red">*)</font> </td>
        </tr>
        <tr> 
          <td class="style1">Branch Full Name</td>
          <td class="style3">
			<asp:TextBox runat="server" id="TbsBranchFullName" Width="315px" CssClass="inptype">
			</asp:TextBox>
&nbsp;<font color="red">*)</font> </td>
        </tr>
        <tr> 
          ...
          <td class="style3"><font color="red">
			<asp:TextBox runat="server" id="TbsBranchInitialName" CssClass="inptype"></asp:TextBox>
			*)</font> </td>
        </tr>
        <tr> 
...
&nbsp;<font color="red">*)</font> </td>
        ...
        <tr> 
          ...
          <td class="style3"><textarea name="textfield342" cols="50" rows="5" class="inptype"></textarea> 
            <font color="red">*)</font> </td>
        </tr>
        <tr> 
          <td class="style1">RT/RW</td>
          <td class="style3"><font face="Tahoma, Verdana" size="2"> 
            <asp:TextBox runat="server" id="TbsRt" Width="30px" CssClass="inptype"></asp:TextBox>
&nbsp;</font>/ <font face="Tahoma, Verdana" size="2"> 
            &nbsp;
			<asp:TextBox runat="server" id="TbsRw" Width="30px" CssClass="inptype"></asp:TextBox>
            </font></td>
        </tr>
        <tr> 
          <td class="style1">Kelurahan</td>
          <td class="style3">
			<asp:TextBox runat="server" id="TbsKelurahan" CssClass="inptype"></asp:TextBox>
&nbsp;<font color="red">*)</font> </td>
        </tr>
        <tr> 
          <td class="style1">Kecamatan</td>
          <td class="style3">
			<asp:TextBox runat="server" id="TbsKecamatan" CssClass="inptype"></asp:TextBox>
&nbsp;<font color="red">*)</font> </td>
        </tr>
        <tr> 
          <td class="style1">City</td>
          <td class="style3">
			<asp:TextBox runat="server" id="TbsCity" CssClass="inptype"></asp:TextBox>
&nbsp;<font color="red">*)</font> </td>
        </tr>
        <tr> 
          <td class="style1">Zip Code</td>
          <td class="style3">
			<asp:TextBox runat="server" id="TbsZipCode" CssClass="inptype"></asp:TextBox>
...
&nbsp;<font color="red">*)</font> </td>
        ...
        <tr> 
          ...
          <td class="style3">
			<asp:TextBox runat="server" id="TbsAreaPhone1" Width="65px" CssClass="inptype">
			</asp:TextBox>
&nbsp;-&nbsp;
			<asp:TextBox runat="server" id="TbsPhone1" CssClass="inptype"></asp:TextBox>
			<font color="red">*)</font> </td>
        </tr>
        <tr> 
...
&nbsp;-&nbsp;
        ...
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbsContactPersonJobTitle" Width="250px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbsContactPersonEmail" Width="250px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbsContactPersonHP" Width="200px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbsBranchManagerName" Width="315px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbsAdhName" Width="315px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbsPICLegalDept" Width="315px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbsArControlName" Width="315px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbsAsset" Width="315px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbnProductivityValue" Width="150px" CssClass="inptype">
			</asp:TextBox>
        ...
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbnProductivityCollection" Width="150px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbnNumberOfEmployee" Width="150px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbsBankAccountName" Width="315px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbsAccountName" Width="315px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
        <tr> 
          ...
          <td class="style3"> 
            <font color="red">
			<asp:TextBox runat="server" id="TbsAccountNo" Width="315px" CssClass="inptype">
			</asp:TextBox>
			</font> </td>
        </tr>
      </table>
