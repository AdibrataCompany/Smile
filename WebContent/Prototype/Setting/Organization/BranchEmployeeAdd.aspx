...
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiorange">BRANCH EMPLOYEE - ADD</td>
    ...
    <div align="center"> 
      <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
        <tr> 
          ...
          <td class="style3">
			<asp:TextBox runat="server" id="TbsEmployeeId" CssClass="inptype"></asp:TextBox>
...
&nbsp; <font color="red">*)</font></td>
        ...
        <tr> 
          <td class="style1">Marketing Group</td>
          <td class="style3">
...
&nbsp;</td>
        ...
        <tr> 
          <td class="style1">Marketing Typ<span class="tdgenap">e</span></td>
          <td class="style3"> 
        ...
        <tr> 
          ...
          <td class="style3"> 
			<asp:DropDownList runat="server" id="CmbProductType" CssClass="inptype">
				<asp:ListItem>Select One</asp:ListItem>
        ...
        <tr> 
          ...
          <td class="style3">
			<asp:TextBox runat="server" id="TbdJoinDate" CssClass="inptype">dd/mm/yyyy</asp:TextBox>
&nbsp;<asp:ImageButton runat="server" id="BtnJoinDate" ImageUrl="../../images/iconcalendar.gif" /></td>
        ...
        <tr> 
          ...
          <td class="style3"><textarea name="textfield342" cols="50" rows="5" class="inptype"></textarea></td>
        </tr>
        <tr> 
