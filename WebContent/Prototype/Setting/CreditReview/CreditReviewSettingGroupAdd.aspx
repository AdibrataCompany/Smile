...
<body>
<form id="frmGroupCriteria" runat="server">
<div align="center">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopiabu"> 
      ...
      <td align="center" class="tdtopiorange">GROUP CRITERIA - ADD</td>
    ...
    <div align="center"> 
      <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
        <tr> 
          ...
          <td class="tdganjil" width="80%"><asp:TextBox ID="txtGroupID" CssClass="inptype" runat="server"></asp:TextBox>
