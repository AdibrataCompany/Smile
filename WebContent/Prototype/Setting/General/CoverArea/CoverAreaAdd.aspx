...
<div align="center">
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopihijau">COVERAGE AREA - ADD</td>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="50%" align="right"><asp:ImageButton id="imbSaveCoverArea" imageurl="../../../Images/ButtonSave.gif" runat="server" PostBackUrl="CoverAreaList.aspx"></asp:ImageButton>
		<asp:ImageButton id="imbCanceCoverArea" imageurl="../../../Images/ButtonCancel.gif" runat="server"></asp:ImageButton>
      </td>
    </tr>
  </table>
  <br>
