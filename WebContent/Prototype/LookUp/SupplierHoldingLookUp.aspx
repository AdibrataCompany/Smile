...
<body>
<form id="FrmSupplierHoldingLookUp" runat="server">
<div align="center">
...
<asp:DropDownList runat="server" id="CmbSearch" CssClass="inptype">
	<asp:ListItem>Supplier Holding Name</asp:ListItem>
	<asp:ListItem>Supplier Holding Business Name</asp:ListItem>
</asp:DropDownList>
&nbsp;
<asp:TextBox runat="server" id="TbsDescriptionSearch" CssClass="inptype"></asp:TextBox>
  ...
  <asp:GridView runat="server" id="GrdViewSupplierLookUp" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%">
	<Columns>
		...
		<asp:boundfield DataField="valstring50" SortExpression="valstring50" HeaderText="SUPPLIER HOLDING NAME">
		</asp:boundfield>
		<asp:boundfield DataField="valstring50" SortExpression="valstring50" HeaderText="SUPPLIER HOLDING BUSINESS NAME">
		</asp:boundfield>
