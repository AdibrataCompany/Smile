...
//Database
aux1 = insFld(foldersTree , gFld('Database', null));
insDoc(aux1, gLnk(2, "Database","Database/Database_Add.aspx"));

//Prospect
aux1 = insFld(foldersTree , gFld('Prospect', null));
insDoc(aux1, gLnk(2, "Prospect","Prospect/Prospect_List.aspx"));
...
// DE Mobil
aux1 = insFld(aux0, gFld('DE Mobil and CF', null));
insDoc(aux1, gLnk(2, "Survey Report DE Mobil","surveyreport/CF/SurveyReport_CF.aspx"));
insDoc(aux1, gLnk(2, "Financial Structure","surveyreport/CF/FinancialDataDEMotor.aspx"));
insDoc(aux1, gLnk(2, "Comission DE Motor","surveyreport/CF/ComissionDEMotor.aspx"));
...
insDoc(aux3, gLnk(2, "Additional TC","Credit/AdditionalTC/AdditionalTC.aspx"));
...
insDoc(aux2, gLnk(2, "Transfer Fund For Prospect Disbursement","Finance/TransferFundForProspect.aspx"));
