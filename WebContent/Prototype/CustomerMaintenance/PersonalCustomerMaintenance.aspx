...
<div align="center"> 
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopihijau">PERSONAL CUSTOMER MAINTENANCE</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
	...
	<tr>
  <td width="20%" class="tdgenap">Maiden Names</td>
      <td class="tdganjil" ><asp:textbox id="txtMaidenName" runat="server" cssclass="inptype" width="300"></asp:textbox> 
		</td>
	</tr>
	</table>
 ...
 / <font face="Tahoma, Verdana" size="2"> 
   ...
   <table width="95%" align="center">
    ...
    <tr>
      ...
      <td class="tdganjil"><font face="Tahoma, Verdana" size="2"> 
   	...
   	<table width="95%">
	 <tr> 
	      <td colspan="4" class="tdjudulhijau">FAMILY CARD</td>
	    </tr>
	</table>
	  <table align="center" width="95%">
  <tr>
  ...
  <asp:GridView runat="server" id="grdOtherExpense" AllowSorting="true" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="100%" >
    ...
    <asp:templatefield HeaderText="NAME">
			<ItemTemplate>
				<asp:textbox runat="server" id="txtFamilyCardName"  CssClass="inptype">
				</asp:textbox>
			</ItemTemplate>
		...
		<asp:templatefield HeaderText="GENDER">
			<ItemTemplate>
				<asp:Dropdownlist runat="server" id="ddlgender" CssClass="inptype">
				<asp:ListItem Text="Select One" Value="0"></asp:ListItem>
		...
		<asp:templatefield HeaderText="RELATIONSHIP">
			<ItemTemplate>
				<asp:Dropdownlist runat="server" id="ddlRelationShip" CssClass="inptype">
				<asp:ListItem Text="Select One" Value="0"></asp:ListItem>
...
<br>
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
	 ...
	 <tr> 
     	<td class="tdgenap" width="20%">Installment Reminder</td>
      	<td class="tdganjil"width="80%"><asp:RadioButtonList runat="server" id="rblInstallmentReminder" RepeatDirection="Horizontal">
...
<br>
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
      <td width="100%" class="tdjudulhijau" colspan="2">CIF NUMBER<font color="red"> </font> 
      </td>
    </tr>
	 <tr> 
     	<td class="tdgenap" width="20%">CIF Number</td>
      	<td class="tdganjil">
      	<asp:textbox id="txtOtherLoanAmountInstallment4" runat="server" cssclass="inptype" Width="251px"></asp:textbox>
      	</td>
    </tr>
