...
<body>
<form id="FrmReceiptCollectorAdd" runat="server">
<div align="center">
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
 	<tr class="trtopikuning"> 
      ...
      <tr> 
      <td class="tdgenap" style="width: 19%; height: 24px;">Receipt No</td>
      <td width="86%" class="tdganjil" style="height: 24px">
      ...
      <td width="86%" class="tdganjil">
       <asp:TextBox runat="server" id="TbnReceiptNo" CssClass="InpType" Columns="3" Width="48px"></asp:TextBox>&nbsp;<font color="red">*)</font> </td>
    </tr>
    <tr> 
