	...
	<body vLink="blue" aLink="black" link="blue">
		<form id="Form2" method="post" runat="server">
			&nbsp;
				...
				<TD class="tdtopibiru" align="center">VIEW FORM CONTROL - PER 
				COLLECTOR</TD>
					...
					<asp:GridView runat="server" id="grdReceiptForm" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="95%">
						<Columns>
							...
							<asp:templatefield HeaderText="BATCH NO">
								<ItemTemplate>
									<asp:HyperLink runat="server" ID="hypBatchNo" NavigateUrl="ViewReceiptForm.aspx" Text="xxxxx20xxxxx"/>
								</ItemTemplate>
							</asp:templatefield>								
							<asp:templatefield HeaderText="FORM CONTROL NO">
								<ItemTemplate>
									<asp:HyperLink runat="server" ID="hypReceiptNo" NavigateUrl="ViewReceiptFormHist.aspx" Text="xxxxx20xxxxx"/>
								</ItemTemplate>
							</asp:templatefield>							
