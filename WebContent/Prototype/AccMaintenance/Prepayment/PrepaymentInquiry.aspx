...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
      ...
      <td class="tdganjil" style="width: 290px"><select name="select5">
    ...
    <tr> 
      ...
      <td class="tdganjil" style="width: 290px"><select name="select4">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right"><a href="PrepaymentInquiryList.aspx"><img src="../../Images/ButtonSearch.gif" width="100" height="20" border="0"></a> 
