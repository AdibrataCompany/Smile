...
<div align="center"> 
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    ...
    <tr> 
      ...
      <td width="25%" class="tdganjil"><select name="select5">
          <option selected>Select One</option>
          <option>Reason 1</option>
          <option>Reason 2</option>
        </select></td>
      <td width="25%" class="tdgenap">Approved by</td>
      <td width="25%" class="tdganjil"><select name="select6">
          <option selected>Select One</option>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <asp:HyperLink ID="imbSave" runat="server" ImageUrl="../../Images/ButtonSave.gif"  NavigateUrl="PrepaymentWithoutRRDAgreementList.aspx"></asp:HyperLink>
      <asp:HyperLink ID="imbCancel" runat="server" ImageUrl="../../Images/ButtonCancel.gif"  NavigateUrl="PrepaymentWithoutRRDAgreementList.aspx"></asp:HyperLink>
		</td>
    </tr>
  </table>
