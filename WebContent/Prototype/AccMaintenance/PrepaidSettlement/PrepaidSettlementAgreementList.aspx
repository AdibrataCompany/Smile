  ...
  <div align="center"> 
    <table width="95%" border="0" cellspacing="0" cellpadding="0">
      <tr class="trtopikuning"> 
        ...
        <td align="center" class="tdtopibiru">PREPAID SETTLEMENT RECEIVE</td>
   ...
   <asp:GridView runat="server" id="grdAgreementList" AutoGenerateColumns="False" DataSourceID="XmlDataSource1" CellPadding="2" Width="100%" >
    <Columns>
		...
		<asp:templatefield HeaderText="ACTION">
			<ItemTemplate>
				<asp:HyperLink runat="server" id="hypAction" ImageUrl="../../images/IconEdit.gif" NavigateURL="PrepaidSettlement.aspx" />
			</ItemTemplate>
			<ItemStyle HorizontalAlign="Center" />
		</asp:templatefield>
		</Columns>
