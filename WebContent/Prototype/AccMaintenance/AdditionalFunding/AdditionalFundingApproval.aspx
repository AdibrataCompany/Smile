...
<div align="center"> 
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
          ...
          <option>Customer</option>
							...
							<SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: 'Times New Roman'; mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">
								<INPUT id="Text1" type="text" name="Text1" class="inptype"></SPAN>
						</font>
					</td>
				</tr>
				<tr>
      ...
      <td width="20%" class="tdganjil"><span class="style4">Additional Funding</span><font face="Tahoma, Verdana" size="2"> 
        Approval</font> </td>
      ...
      <td colspan="2" align="right" class="tdganjil">&nbsp;</td>
				</tr>
				<tr>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr align="center" class="tdjudulbiru"> 
      ...
      <td width="10%"><u>REQ. DATE</u></td>
      <td width="5%"><u>DURATION (a/b/c)</u></td>
      <td width="5%">LEVEL PATH</td>
      <td width="5%" class="style3">PROD TYPE</td>
    ...
    <tr> 
      ...
      <td class="tdganjil"><div align="center"><a href="javascript:;" onClick="MM_openBrWindow('../Credit/ViewAgreement.htm','Agreement','scrollbars=yes,width=900,height=700,top=1,left=1')">xxxx20xxxx</a></div></td>
      ...
      <td class="tdganjil">xxxx/xxxxx</td>
      <td class="style2">xx</td>
      <td align="center" class="tdganjil"><a href="AdditionalFundingApprovalDetail.aspx">Approval</a></td>
    ...
    <tr> 
      ...
      <td class="tdgenap"><div align="center"><a href="javascript:;" onClick="MM_openBrWindow('../Credit/ViewAgreement.htm','Agreement','scrollbars=yes,width=900,height=700,top=1,left=1')">xxxx20xxxx</a></div></td>
      ...
      <td class="tdgenap">xxxx/xxxxx</td>
      <td class="style1">xx</td>
      <td align="center" class="tdgenap"><a href="AdditionalFundingApprovalDetail.aspx">Approval</a></td>
