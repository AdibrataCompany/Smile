...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr class="trtopikuning"> 
      ...
      <td align="center" class="tdtopibiru">AGREEMENT ADDITIONAL FUNDING INQUIRY</td>
  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
    <tr> 
      ...
      <td width="40%" class="tdganjil"><select name="select2">
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="50%" align="right"><a href="AdditionalFundingInquiryList.aspx"><img src="../../Images/ButtonSearch.gif" width="100" height="20" border="0"></a> 
