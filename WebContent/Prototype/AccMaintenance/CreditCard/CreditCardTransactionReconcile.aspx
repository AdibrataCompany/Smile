  ...
  <table width="95%" border="0" cellpadding="2" cellspacing="1" class="tablegrid">
   <tr> 
    ...
    <tr>
	 ...
	 <tr>
     	<td class="tdgenap" width="20%">Amount Clearing</td>
	   	<td class="tdganjil" width="30%" colspan="3"><asp:textbox  ID="txtAmountClearing" runat="server" CssClass="inptype"></asp:TextBox></td>
		</tr>
  </table>
  <table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
