...
public class SuspendReceive implements java.io.Serializable
	{
		...
		public SuspendReceive(long id, Office office, Partner partner, String suspendCode, Date valueDate, Date postingDate, Double amount, Long currencyId, Double currencyRate, Long bankAccountId, Long jobId, String status, String notes,
		        Date dtmUpd, String usrUpd, Date dtmCrt, String usrCrt, Set<SuspendReverse> suspendReverses, Set<SuspendAllocation> suspendAllocations)
			{
				this.id = id;
				this.office = office;
		...
		@Column(name = "SuspendCode", length = 20)
