...
public class DailyAraging  implements java.io.Serializable {
    ...
    public DailyAraging(long id, long customerId, long currencyId, double amountOverDueGross, double amountOverDuePrinciple) {
        this.id = id;
    ...
    public DailyAraging(long id, Date agingDate, Long agrmntId, long customerId, String dailyMonthly, Integer daysOverdue, long currencyId, double amountOverDueGross, double amountOverDuePrinciple, Double osp, Double osi, Double ospundue, Double osiundue, Double lcinst, Double lcinstPaid, Double lcinstWaived, Date lastLcinstCalcDate, Double lcinstCurrrent, Double lcins, Double lcinsPaid, Double lcinsWaived, Date lastLcinsCalcDate, Double instDue, Double instDuePaid, Double instDueWaived, Double insDue, Double insDuePaid, Double insDueWaived, Double prepaidAmount, Date nadate, Double naamount, Double napaid, Double naother, Date wodate, Double woamount, Double wopaid, Double woother, Short collStatus, Short exRepo, Short installmentNo, Date installmentDate, String contractStatus, String defaultStatus, Integer numOfAssetUnit, Integer collectibilityId, Short nextInstDueNumber, Date nextInstDueDate, Short isFpd, Long productId, Long productOfferingId, Double ntf, Date dtmUpd, String usrUpd, Date dtmCrt, String usrCrt) {
       this.id = id;
