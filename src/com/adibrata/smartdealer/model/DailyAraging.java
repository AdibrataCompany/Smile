...
public class DailyAraging implements java.io.Serializable
	{
		...
		public DailyAraging(long id, Date agingDate, Long agrmntId, long customerId, String dailyMonthly, Integer daysOverdue, long currencyId, double amountOverDueGross, double amountOverDuePrinciple, Double osp, Double osi, Double ospundue,
