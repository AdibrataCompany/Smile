...
public class DailyAraging implements java.io.Serializable
	{
		...
		public DailyAraging(long id, Date agingDate, Long agrmntId, long customerId, Integer daysOverdue, long currencyId, double amountOverDueGross, double amountOverDuePrinciple, Double osp, Double osi, Double ospundue, Double osiundue,
		        Double lcinst, Double lcinstPaid, Double lcinstWaived, Date lastLcinstCalcDate, Double lcinstCurrrent, Double lcins, Double lcinsPaid, Double lcinsWaived, Date lastLcinsCalcDate, Double instDue, Double instDuePaid,
