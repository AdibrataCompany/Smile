 ...
 */
@Entity
@Table(name = "AssetCategory", schema = "dbo", catalog = "SmartDealer")
public class AssetCategory implements java.io.Serializable {
	...
	public AssetCategory(long id, Long assetTypeId,
			String insAssetCategoryCode, String description, Date dtmUpd,
