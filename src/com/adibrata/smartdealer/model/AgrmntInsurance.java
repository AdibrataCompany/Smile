...
public class AgrmntInsurance implements java.io.Serializable
	{
		...
		public AgrmntInsurance(long id, Agrmnt agrmnt, Long appId, Long currencyId, Long insuranceCoyId, Long insuranceCoyBranchId, String applicationType, double mainPremiumToCust, double loadingFeeToCust, double tpltoCust, double floodToCust,
		        double srcctoCust, double premiumAmountByCustBeforeDisc, double discToCustAmount, double premiumAmountByCust, double adminFeeToCust, double meteraiFeeToCust, double capitalizedAmount, Date startDate, Date endDate,
		        String policyNumber, Date policyReceiveDate, String policyReceiveBy, String flagInsActivation, String flagReNew, String flagInsStatus, Date sppadate, String sppano, String insuranceRateType, double mainStdPremium,
		        double srccstdPremium, double floodStdPremium, double tplstdPremium, double tplstdAmount, double totalStdPremium, double sumInsured, double srcctoInsco, double tpltoInsco, double floodToInsCo, double loadingFeeToInsCo,
		        double mainPremiumToInsCo, double premiumAmountToInsCo, Date insCoSelectionDate, double sellingRate, double sellingAmount, double adminFee, double meteraiFee, double paidAmountToInsco, double earnAmount, String insNotes,
		        String accNotes, Date requestDate, Date insActivateDate, short insLength, String mainCoverage, String additionalCoverage, String endorsDocNo, String bdendorsDocNo, Date bdendorsDate, String bdendorsPolicyNo,
		        Date bdendorsPolicyReceiveDate, double endorsToInsCoPremium, double endorsPaidToInsCo, double endorsAdditionalPremium, String flagClaimProcess, Date lastClaimDate, char flagDocStatus, double paidAmountByCust,
		        Double waivedAmountByCust, Date paidDate, double lateCharges, long accPayId, String insuredBy, String insurancePaidBy, double claimAmount, double paidClaimAmount, int yearNum, Date terminationDate, String isChangeInsCo,
		        String changeInsCoReason, String coverPeriod, String renewalDocNo, Date renewalDocDate, Double premiumBaseForRefundSupp, String invoiceNo, Double invoiceAmount, Date invoiceDate, Date receivedInvoiceDate, Date flagInsStatusDate,
		        Character sppaprintStatus, boolean isValidCustomerName, boolean isValidAddress, boolean isValidInsurancePeriode, boolean isValidInsLength, boolean isValidNumOfAsset, boolean isValid, Double insCapitalizedAmount,
		        Double addCapitalizedAmount, short isNewCover, String batchId, Date batchDate, String generate, String typeCorrectionCode, Date confirmDate, String usrCrt, Date dtmUpd, String usrUpd, Date dtmCrt)
			{
				this.id = id;
				this.agrmnt = agrmnt;
				this.appId = appId;
