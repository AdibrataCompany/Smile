...
public class OtherDsbHdr implements java.io.Serializable
	{
		...
		public OtherDsbHdr(long id, Office office, Partner partner, String otherDisbCode, Double disbAmount, Date postingDate, Date valueDate, Long bankAccountId, String refNo, String notes, String destination, Long jobId, Date dtmUpd, String usrUpd,
		        Date dtmCrt, String usrCrt, Set<OtherDsbDtl> otherDsbDtls)
			{
				this.id = id;
				this.office = office;
				this.partner = partner;
				this.otherDisbCode = otherDisbCode;
		...
		@Column(name = "OtherDisbCode", length = 20)
		public String getOtherDisbCode()
			{
				return this.otherDisbCode;
			}
			
		public void setOtherDisbCode(String otherDisbCode)
			{
				this.otherDisbCode = otherDisbCode;
			}
