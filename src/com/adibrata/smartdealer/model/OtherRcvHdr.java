...
public class OtherRcvHdr implements java.io.Serializable
	{
		...
		public OtherRcvHdr(long id, Office office, Partner partner, String otherRcvCode, String rcvFrom, Double rcvAmount, String reffNo, Date postingDate, Date valueDate, Long bankAccountId, String notes, Long jobId, Date dtmUpd, String usrUpd,
		        Date dtmCrt, String usrCrt, Set<OtherRcvDtl> otherRcvDtls)
			{
				this.id = id;
				this.office = office;
				this.partner = partner;
				this.otherRcvCode = otherRcvCode;
		...
		@Column(name = "OtherRcvCode", length = 20)
		public String getOtherRcvCode()
			{
				return this.otherRcvCode;
			}
			
		public void setOtherRcvCode(String otherRcvCode)
			{
				this.otherRcvCode = otherRcvCode;
			}
