 ...
 */
@Entity
@Table(name = "Sales", schema = "dbo", catalog = "SmartDealer")
public class Sales implements java.io.Serializable {
	...
	public Sales(long id, String partnerCode, Long officeId, Long appId,
			...
			long aosupervisorId, long caid, Long gmid, Long bmid, Long adhid,
			Long salesmanId, Long salesSupervisorId, Long supplierAdminId,
			double totalOtr, double downPayment, double ntf,
			String financeType, String productType, short numOfAssetUnit,
			String wayOfPayment, String floatingPeriod, Double insAssetPremium,
			...
			String firstInstallment, String installmentScheme,
			String interestType, short numOfInstallment, short tenor,
			short cummulativeTenor, double installmentAmount, Date gracePeriod,
			String gracePeriodType, double grossYield,
			...
			String notes, String usrCrt, Date dtmUpd, String usrUpd, Date dtmCrt) {
		this.id = id;
