...
public class AccountPayable implements java.io.Serializable
	{
		...
		*/
		...
		public AccountPayable(final long id, final Office office, final Partner partner, final String apno, final String aptype, final String apstatus, final Date apdate, final String referenceNo, final String description, final Date dueDate,
		        final long currencyId, final double currencyRate, final Double apamount, final Double apdisburse, final String apto, final String accNameTo, final String accNoTo, final String bankMasterTo, final String bankBranchTo,
		        final Long officeDisbId, final String usrCrt, final Date dtmUpd, final String usrUpd, final Date dtmCrt, final Set<Pvdetail> pvdetails)
			{
				this.id = id;
				this.office = office;
		...
		public void setOfficeDisbId(final Long officeDisbId)
			{
				this.officeDisbId = officeDisbId;
			}
