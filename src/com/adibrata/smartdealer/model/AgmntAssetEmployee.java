...
/**
 * AgmntAssetEmployee generated by hbm2java
 */
@Entity @Cacheable @Cache(usage = CacheConcurrencyStrategy.TRANSACTIONAL)
@Table(name = "AgmntAssetEmployee", catalog = "SmartDealer")
public class AgmntAssetEmployee implements java.io.Serializable
	{
		...
		public AgmntAssetEmployee()
			{
			}
			
		public AgmntAssetEmployee(long id)
			{
				this.id = id;
			}
			
		public AgmntAssetEmployee(long id, AgrmntAsset agrmntAsset, Long salesmanId, Long salesSupervisorId, Long supplierAdminId, Long gmid, Long bmid, Long adhid, String usrCrt, Date dtmUpd, String usrUpd, Date dtmCrt)
			{
				this.id = id;
