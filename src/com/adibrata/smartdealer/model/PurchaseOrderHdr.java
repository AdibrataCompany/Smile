...
public class PurchaseOrderHdr implements java.io.Serializable
	{
		...
		public PurchaseOrderHdr(long id, Office office, Partner partner, Supplier supplier, String pono, Date podate, Long currencyId, Double currencyRate, Double poamount, Long jobId, Serializable bankName, Serializable accountName,
		        Serializable accountNo, Short isMainPo, Date pooriginalExpiredDate, Date poexpiredDate, Short isExpired, Short isEmailSupplier, Serializable emailSupplier, Short isFaxSupplier, String supplierFaxAreaCode, String supplierFaxNumber,
		        Short isEmailInsCo, String emailInsCo, Short isFaxInsCo, String insCoFaxAreaCode, String insCoFaxNumber, Date supplierBillingDate, Date deliveryDate, Short isCancelled, Date cancellationDate, Integer poextendCounter,
		        Short isRcaagain, String notes, Serializable bankBranch, Long apid, Double contractPrepaidAmount, Long supplierBankId, String supplierBankBranch, String supplierAccountNo, String supplierAccountName, Date dtmUpd, String usrUpd,
		        Date dtmCrt, String usrCrt, Set<ReturPurchaseHdr> returPurchaseHdrs, Set<PurchaseInvoice> purchaseInvoices, Set<PurchaseOrderDtl> purchaseOrderDtls)
			{
				this.id = id;
				this.office = office;
