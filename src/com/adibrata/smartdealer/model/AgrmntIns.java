...
public class AgrmntIns implements java.io.Serializable
	{
		...
		private String insuredPaidByCode;
		...
		public AgrmntIns(long id, Agrmnt agrmnt, InsCoOffice insCoOffice, Long currencyId, String applicationType, String insuredByCode, String insuredPaidByCode, String coveragePeriod, Date startDate, Date endDate, String policyNumber,
		        ...
		        String usrUpd, Date dtmCrt, Set<AgrmntInsAsset> agrmntInsAssets, Set<AgrmntInsStandardInfo> agrmntInsStandardInfos, Set<AgrmntInsInsco> agrmntInsInscos, Set<AgrmntInsCust> agrmntInsCusts)
			{
				...
				this.insuredPaidByCode = insuredPaidByCode;
		...
		@Column(name = "InsuredByCode", length = 20)
		public String getInsuredByCode()
			{
				return this.insuredByCode;
			}
		...
		@Column(name = "InsuredPaidByCode", length = 20)
		public String getInsuredPaidByCode()
			{
				return this.insuredPaidByCode;
			}
			
		public void setInsuredPaidByCode(String insuredPaidByCode)
			{
				this.insuredPaidByCode = insuredPaidByCode;
			}
			
		@Column(name = "CoveragePeriod", length = 20)
