...
public class AgrmntIns implements java.io.Serializable
	{
		...
		private Long insCompanyOfficeId;
		...
		public AgrmntIns(long id, Agrmnt agrmnt, Long currencyId, Long insCompanyOfficeId, String applicationType, Date startDate, Date endDate, String policyNumber, Date policyReceiveDate, String policyReceiveBy, String flagInsActivation,
		        ...
		        Double addCapitalizedAmount, short isNewCover, String batchId, Date batchDate, String generate, String typeCorrectionCode, Date confirmDate, String usrCrt, Date dtmUpd, String usrUpd, Date dtmCrt, Set<AgrmntInsAsset> agrmntInsAssets)
			{
				...
				this.insCompanyOfficeId = insCompanyOfficeId;
		...
		@Column(name = "InsCompanyOfficeId")
		public Long getInsCompanyOfficeId()
			{
				return this.insCompanyOfficeId;
			}
			
		public void setInsCompanyOfficeId(Long insCompanyOfficeId)
			{
				this.insCompanyOfficeId = insCompanyOfficeId;
			}
