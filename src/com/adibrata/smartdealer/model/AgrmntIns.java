...
public class AgrmntIns implements java.io.Serializable
	{
		...
		private Set<AgrmntInsAsset> agrmntInsAssets_1 = new HashSet<AgrmntInsAsset>(0);
		
		public AgrmntIns()
			{
			}
			
		public AgrmntIns(long id, double mainPremiumToCust, double loadingFeeToCust, double tpltoCust, double floodToCust, double srcctoCust, double premiumAmountByCustBeforeDisc, double discToCustAmount, double premiumAmountByCust,
		        ...
		        String flagDocStatus, double paidAmountByCust, double lateCharges, long accPayId, double claimAmount, double paidClaimAmount, int yearNum, String isChangeInsCo, String changeInsCoReason, String coverPeriod, String renewalDocNo,
		...
		public AgrmntIns(long id, Agrmnt agrmnt, Long currencyId, Long insuranceCoyId, Long insuranceCoyBranchId, String applicationType, double mainPremiumToCust, double loadingFeeToCust, double tpltoCust, double floodToCust, double srcctoCust,
		        double premiumAmountByCustBeforeDisc, double discToCustAmount, double premiumAmountByCust, double adminFeeToCust, double meteraiFeeToCust, double capitalizedAmount, Date startDate, Date endDate, String policyNumber,
		        ...
		        double endorsPaidToInsCo, double endorsAdditionalPremium, String flagClaimProcess, Date lastClaimDate, String flagDocStatus, double paidAmountByCust, Double waivedAmountByCust, Date paidDate, double lateCharges, long accPayId,
		        ...
		        Double premiumBaseForRefundSupp, String invoiceNo, Double invoiceAmount, Date invoiceDate, Date receivedInvoiceDate, Date flagInsStatusDate, String sppaprintStatus, boolean isValidCustomerName, boolean isValidAddress,
		        ...
		        String typeCorrectionCode, Date confirmDate, String usrCrt, Date dtmUpd, String usrUpd, Date dtmCrt, Set<AgrmntInsAsset> agrmntInsAssets, Set<AgrmntInsAsset> agrmntInsAssets_1)
			{
				this.id = id;
				this.agrmnt = agrmnt;
				...
				this.agrmntInsAssets_1 = agrmntInsAssets_1;
			}
		...
		@OneToMany(fetch = FetchType.LAZY, mappedBy = "agrmntIns")
		public Set<AgrmntInsAsset> getAgrmntInsAssets_1()
			{
				return this.agrmntInsAssets_1;
			}
			
		public void setAgrmntInsAssets_1(Set<AgrmntInsAsset> agrmntInsAssets_1)
			{
				this.agrmntInsAssets_1 = agrmntInsAssets_1;
			}
