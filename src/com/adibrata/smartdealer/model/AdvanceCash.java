...
public class AdvanceCash implements java.io.Serializable
	{
		...
		public AdvanceCash(long id, BankAccount bankAccount, Currency currency, Employee employee, Office office, Partner partner, String advanceCode, Double advanceAmount, Date postingDate, Date valueDate, Double currencyRate, String notes,
