...
public class BucketAgingReport  implements java.io.Serializable {
    ...
    public BucketAgingReport(long id, String bucketName, int bucket1From, int bucket1To, String bucket1Text, int bucket2From, int bucket2To, String bucket2Text, int bucket3From, int bucket3To, String bucket3Text, int bucket4From, int bucket4To, String bucket4Text, int bucket5From, int bucket5To, String bucket5Text, int bucket6From, int bucket6To, String bucket6Text, int bucket7From, int bucket7To, String bucket7Text, int bucket8From, int bucket8To, String bucket8Text, int bucket9From, int bucket9To, String bucket9Text, int bucket10From, int bucket10To, String bucket10Text) {
        this.id = id;
    ...
    public BucketAgingReport(long id, String partnerCode, String reportCode, String bucketName, int bucket1From, int bucket1To, String bucket1Text, int bucket2From, int bucket2To, String bucket2Text, int bucket3From, int bucket3To, String bucket3Text, int bucket4From, int bucket4To, String bucket4Text, int bucket5From, int bucket5To, String bucket5Text, int bucket6From, int bucket6To, String bucket6Text, int bucket7From, int bucket7To, String bucket7Text, int bucket8From, int bucket8To, String bucket8Text, int bucket9From, int bucket9To, String bucket9Text, int bucket10From, int bucket10To, String bucket10Text, Date dtmUpd, String usrUpd, Date dtmCrt, String usrCrt) {
       this.id = id;
