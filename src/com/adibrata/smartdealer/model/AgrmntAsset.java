...
public class AgrmntAsset implements java.io.Serializable
	{
		...
		public AgrmntAsset(long id, Agrmnt agrmnt, AssetMaster assetMaster, Customer customer, SupplierAccInfo supplierAccInfo, Long supplierId, double otrprice, double dpamount, long assetTypeId, double resaleValue, String serialNo1,
		        ...
		        Set<AgrmntAssetLoctInfo> agrmntAssetLoctInfos, Set<AgrmntAssetLevelInfo> agrmntAssetLevelInfos, Set<AgrmntAssetOwnerInfo> agrmntAssetOwnerInfos, Set<AgrmntAssetOldOwnerInfo> agrmntAssetOldOwnerInfos,
		        Set<AgrmntInsAsset> agrmntInsAssets, Set<AgmntAssetEmployeeInfo> agmntAssetEmployeeInfos, Set<AgrmntAssetSpbkbinfo> agrmntAssetSpbkbinfos)
			{
				this.id = id;
				this.agrmnt = agrmnt;
				this.assetMaster = assetMaster;
