...
/**
 * PersCustTrusteeInfo generated by hbm2java
 */
@Entity @Cacheable @Cache(usage = CacheConcurrencyStrategy.TRANSACTIONAL)
@Table(name = "PersCustTrusteeInfo", catalog = "SmartDealer")
public class PersCustTrusteeInfo implements java.io.Serializable
	{
		
		private long id;
		private Customer customer;
		private Serializable trusteeName;
		...
		public PersCustTrusteeInfo()
			{
			}
		
		public PersCustTrusteeInfo(long id)
			{
				this.id = id;
			}
		
		public PersCustTrusteeInfo(long id, Customer customer, Serializable trusteeName, String trusteeIdnumber, String address, String rt, String rw, String kelurahan, String kecamatan, String city, String zipcode, String areaPhone1,
		        String phoneNo1, String areaPhone2, String phoneNo2, String areaFax, String faxNo, String handphone, String fullAddress, String usrCrt, Date dtmUpd, String usrUpd, Date dtmCrt)
			{
				this.id = id;
		...
		public Serializable getTrusteeName()
			{
				return this.trusteeName;
			}
		
		public void setTrusteeName(Serializable trusteeName)
			{
				this.trusteeName = trusteeName;
			}
		
		@Column(name = "TrusteeIDNumber", length = 40)
		public String getTrusteeIdnumber()
			{
				return this.trusteeIdnumber;
			}
		
		public void setTrusteeIdnumber(String trusteeIdnumber)
			{
				this.trusteeIdnumber = trusteeIdnumber;
			}
