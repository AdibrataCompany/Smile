...
/**
 * AgrmntAssetOwner generated by hbm2java
 */
@Entity @Cacheable @Cache(usage = CacheConcurrencyStrategy.TRANSACTIONAL)
@Table(name = "AgrmntAssetOwner", catalog = "SmartDealer")
public class AgrmntAssetOwner implements java.io.Serializable
	{
		...
		public AgrmntAssetOwner()
			{
			}
			
		public AgrmntAssetOwner(long id, String zipcode)
			{
				this.id = id;
				this.zipcode = zipcode;
			}
			
		public AgrmntAssetOwner(long id, AgrmntAsset agrmntAsset, String name, String spouseName, String idNumber, String address, String rt, String rw, String kelurahan, String kecamatan, String city, String zipcode, String areaPhone1,
