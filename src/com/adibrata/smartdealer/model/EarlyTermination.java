 ...
 */
@Entity
@Table(name = "EarlyTermination", schema = "dbo", catalog = "SmartDealer")
public class EarlyTermination implements java.io.Serializable {
	...
	public EarlyTermination(long id, String etcode, double currencyRate,
			...
			String insuranceTerminationFlag, String notes, String reasonTypeId,
			String reasonId, long jobId, String prepaymentStatus,
			Date statusDate, String requestBy, long approvalId,
			double osadminFee, double accruedAdminFeeEom) {
		this.id = id;
		this.etcode = etcode;
	...
	public EarlyTermination(long id, Long agrmntId, String etcode,
			...
			double outstandingInterest, double outstandingPrincipalBankPortion,
			double outstandingInterestBankPortion, double osinstallmentDue,
			double osinstallmentDueBankPortion, double osinsuranceDue,
			double oslcinstallment, double oslcinsurance,
			double lcinstallmentCurrent, double lcinsuranceCurrent,
			...
			double osinsuranceClaimExpense, double osrepossesFee,
			double prepaymentFee, double accruedInterest,
			Double accruedInterestBankPortion, double lcinstallmentAmountDisc,
			double lcinsuranceAmountDisc, double installCollectionFeeDisc,
			double insurCollectionFeeDisc, double pdcbounceFeeDisc,
			double stnkfeeDisc, double insuranceClaimExpenseDisc,
			double repossesFeeDisc, double insuranceAmountDisc,
			double installmentAmountDisc, double prepaymentFeeDisc,
			double prepaidAmount, String insuranceTerminationFlag,
			String notes, String reasonTypeId, String reasonId, long jobId,
			String prepaymentStatus, Date statusDate, String requestBy,
			long approvalId, Double accruedInterestDisc, Double osprincipalDue,
			Double osprincipalDueBankPortion, Double osinterestDue,
			Double osinterestDueBankPortion, Double principalDueDisc,
			Double interestDueDisc, Double toleranceAmount, Double osdiffRate,
