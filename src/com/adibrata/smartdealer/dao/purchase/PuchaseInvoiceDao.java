 ...
 *
 */
public class PuchaseInvoiceDao extends DaoBase
implements
PurchaseInvoiceService {
	...
	@Override
	public void Save(String usrupd, PurchaseInvoice purchaseInvoice)
			throws Exception {
		// TODO Auto-generated method stub
		this.session.getTransaction().begin();
		try {
			final String transno = TransactionNo(this.session,
					TransactionType.purchaseinvoice, purchaseInvoice
					.getPartner().getPartnerCode(), purchaseInvoice
					.getOffice().getId());
