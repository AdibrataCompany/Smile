		...
		public void Save(final String usrupd, final PurchaseOrderHdr purchaseOrderHdr, final List<PurchaseOrderDtl> lstpurchaseOrderDtl) throws Exception
			{
				...
				try
					{
						final String transno = TransactionNo(this.session, TransactionType.purchaseorder, purchaseOrderHdr.getPartner().getPartnerCode(), purchaseOrderHdr.getOffice().getId());
