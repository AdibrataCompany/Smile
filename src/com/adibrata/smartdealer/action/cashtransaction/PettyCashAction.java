...
public class PettyCashAction extends BaseAction implements Preparable
	{
		...
		public void prepare() throws Exception
			{
				...
				try
					{
						this.hdr = ActionContext.getContext().getSession();
				...
				try
					{
						...
						pettycashhdr.setBankAccount(this.bankaccount);
						pettycashhdr.setEmployee(this.employee);
						pettycashhdr.setNotes(this.notes);
						pettycashhdr.setPcamount(this.amount);
						pettycashhdr.setValueDate(this.dateformat.parse(this.valuedate));
						pettycashhdr.setCashierHistoryId(BaseAction.sesCashierHistoryId());
						this.hdr.put("hdr", pettycashhdr);
		 ...
		 *            the hdr to set
		 */
		public void setHdr(final Map<String, Object> hdr)
			{
				this.hdr = hdr;
			}
		 ...
		 * @return the hdr
		 */
		public Map<String, Object> getHdr()
			{
				return this.hdr;
			}
