...
package com.adibrata.smartdealer.action.credit.asset;

import com.adibrata.smartdealer.action.BaseAction;
import com.adibrata.smartdealer.model.Agrmnt;
import com.adibrata.smartdealer.model.AgrmntAsset;
...
public class AssetDataAction extends BaseAction implements Preparable
	{
		/**
		*
		*/
		...
		private AgrmntAsset asset;
		
		public AssetDataAction() throws Exception
			{
		 ...
		 *            the asset to set
		 */
		public void setAsset(final AgrmntAsset asset)
			{
				this.asset = asset;
			}
	}
